...
web2grid.worksource.boinc.reply.ResultSlot = function(node) { if( node === $_ ) return; {
	$s.push("web2grid.worksource.boinc.reply.ResultSlot::new");
	var $spos = $s.length;
...
web2grid.core.iface.Persistent = function() { }
web2grid.core.iface.Persistent.__name__ = ["web2grid","core","iface","Persistent"];
web2grid.core.iface.Persistent.prototype.init = null;
web2grid.core.iface.Persistent.prototype.isChanged = null;
web2grid.core.iface.Persistent.prototype.hxSerialize = null;
web2grid.core.iface.Persistent.prototype.hxUnserialize = null;
web2grid.core.iface.Persistent.prototype.__class__ = web2grid.core.iface.Persistent;
...
web2grid.core.work.WorkUnitPool = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.core.work.WorkUnitPool::new");
	var $spos = $s.length;
	this.workunits = new Array();
	this.init();
	$s.pop();
}}
web2grid.core.work.WorkUnitPool.__name__ = ["web2grid","core","work","WorkUnitPool"];
web2grid.core.work.WorkUnitPool.prototype.workunits = null;
web2grid.core.work.WorkUnitPool.prototype.changed = null;
web2grid.core.work.WorkUnitPool.prototype.init = function() {
	$s.push("web2grid.core.work.WorkUnitPool::init");
	var $spos = $s.length;
	this.changed = false;
	$s.pop();
}
web2grid.core.work.WorkUnitPool.prototype.add = function(work) {
	$s.push("web2grid.core.work.WorkUnitPool::add");
	var $spos = $s.length;
	this.workunits.push(work);
	this.changed = true;
	$s.pop();
}
web2grid.core.work.WorkUnitPool.prototype.addFirst = function(work) {
	$s.push("web2grid.core.work.WorkUnitPool::addFirst");
	var $spos = $s.length;
	this.workunits.unshift(work);
	this.changed = true;
	$s.pop();
}
web2grid.core.work.WorkUnitPool.prototype.startOne = function() {
	$s.push("web2grid.core.work.WorkUnitPool::startOne");
	var $spos = $s.length;
	var _g = 0, _g1 = this.workunits;
	while(_g < _g1.length) {
		var work = _g1[_g];
		++_g;
		if(work.getState() == web2grid.core.iface.WorkUnitState.Passive) {
			work.start();
			{
				$s.pop();
				return;
...
web2grid.core.work.WorkUnitPool.prototype.terminateOne = function() {
	...
	while(i >= 0) {
		...
		if(work.getState() == web2grid.core.iface.WorkUnitState.Active) {
			work.terminate();
...
web2grid.core.work.WorkUnitPool.prototype.terminateAll = function() {
	$s.push("web2grid.core.work.WorkUnitPool::terminateAll");
	var $spos = $s.length;
	var _g = 0, _g1 = this.workunits;
	while(_g < _g1.length) {
		var work = _g1[_g];
...
web2grid.core.work.WorkUnitPool.prototype.getNumInit = function() {
	$s.push("web2grid.core.work.WorkUnitPool::getNumInit");
	var $spos = $s.length;
	var nr = 0;
	{
		var _g = 0, _g1 = this.workunits;
		while(_g < _g1.length) {
			var work = _g1[_g];
			++_g;
			if(work.getState() == web2grid.core.iface.WorkUnitState.Init) {
				nr++;
			}
		}
	}
...
web2grid.core.work.WorkUnitPool.prototype.getNumPassive = function() {
	$s.push("web2grid.core.work.WorkUnitPool::getNumPassive");
	var $spos = $s.length;
	var nr = 0;
	{
		var _g = 0, _g1 = this.workunits;
...
web2grid.core.work.WorkUnitPool.prototype.getNumActive = function() {
	$s.push("web2grid.core.work.WorkUnitPool::getNumActive");
	var $spos = $s.length;
	var nr = 0;
	{
		var _g = 0, _g1 = this.workunits;
...
web2grid.core.work.WorkUnitPool.prototype.getNumCompleted = function() {
	$s.push("web2grid.core.work.WorkUnitPool::getNumCompleted");
	var $spos = $s.length;
	var nr = 0;
	{
		var _g = 0, _g1 = this.workunits;
		while(_g < _g1.length) {
			var work = _g1[_g];
			++_g;
			if(work.getState() == web2grid.core.iface.WorkUnitState.Completed) {
				nr++;
			}
		}
	}
...
web2grid.core.work.WorkUnitPool.prototype.getCompleted = function() {
	$s.push("web2grid.core.work.WorkUnitPool::getCompleted");
	var $spos = $s.length;
...
web2grid.core.work.WorkUnitPool.prototype.removeCompleted = function() {
	$s.push("web2grid.core.work.WorkUnitPool::removeCompleted");
	var $spos = $s.length;
	var result = new Array();
	{
		var _g = 0, _g1 = this.workunits;
...
web2grid.core.work.WorkUnitPool.prototype.getWorkUnits = function() {
	$s.push("web2grid.core.work.WorkUnitPool::getWorkUnits");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkUnitPool.prototype.operate = function() {
	$s.push("web2grid.core.work.WorkUnitPool::operate");
	var $spos = $s.length;
	var _g = 0, _g1 = this.workunits;
	while(_g < _g1.length) {
		var item = _g1[_g];
...
web2grid.core.work.WorkUnitPool.prototype.getScreenName = function() {
	$s.push("web2grid.core.work.WorkUnitPool::getScreenName");
	var $spos = $s.length;
	{
		$s.pop();
		return "WorkUnitPool";
...
web2grid.core.work.WorkUnitPool.prototype.isChanged = function() {
	$s.push("web2grid.core.work.WorkUnitPool::isChanged");
	var $spos = $s.length;
	{
		var _g = 0, _g1 = this.workunits;
		while(_g < _g1.length) {
...
web2grid.core.work.WorkUnitPool.prototype.hxSerialize = function(s) {
	$s.push("web2grid.core.work.WorkUnitPool::hxSerialize");
	var $spos = $s.length;
	s.serialize(this.workunits);
	this.changed = false;
	$s.pop();
}
web2grid.core.work.WorkUnitPool.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.core.work.WorkUnitPool::hxUnserialize");
	var $spos = $s.length;
...
web2grid.worksource.boinc.request.UploadFileInfo = function(reply_file_info) { if( reply_file_info === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.UploadFileInfo::new");
	var $spos = $s.length;
...
web2grid.worksource.boinc.request.UploadFileInfo.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.UploadFileInfo::toXmlString");
	var $spos = $s.length;
...
web2grid.worksource.boinc.request.Host = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.Host::new");
	var $spos = $s.length;
	this.hostid = null;
	this.host_info = new web2grid.worksource.boinc.request.HostInfo();
	$s.pop();
}}
...
web2grid.worksource.boinc.request.Host.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.Host::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
	var xml = "";
...
web2grid.core.work.WorkSourcePool = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.core.work.WorkSourcePool::new");
	var $spos = $s.length;
	this.worksources = new Array();
	this.targetactive = 1;
	this.currentwsindex = 0;
	this.init();
	henkolib.log.Console.main.logNotice("WorkSourcePool created: targetactive = " + this.targetactive,null,null,{ fileName : "WorkSourcePool.hx", lineNumber : 24, className : "web2grid.core.work.WorkSourcePool", methodName : "new"});
	$s.pop();
}}
web2grid.core.work.WorkSourcePool.__name__ = ["web2grid","core","work","WorkSourcePool"];
web2grid.core.work.WorkSourcePool.prototype.worksources = null;
web2grid.core.work.WorkSourcePool.prototype.targetactive = null;
web2grid.core.work.WorkSourcePool.prototype.currentwsindex = null;
web2grid.core.work.WorkSourcePool.prototype.changed = null;
web2grid.core.work.WorkSourcePool.prototype.init = function() {
	$s.push("web2grid.core.work.WorkSourcePool::init");
	var $spos = $s.length;
	this.changed = false;
	this.currentwsindex = 0;
	this.changed = false;
...
web2grid.core.work.WorkSourcePool.prototype.addWorkSource = function(ws) {
	$s.push("web2grid.core.work.WorkSourcePool::addWorkSource");
	var $spos = $s.length;
	this.worksources.push(ws);
	this.changed = true;
	$s.pop();
}
web2grid.core.work.WorkSourcePool.prototype.removeWorkSource = function(ws) {
	$s.push("web2grid.core.work.WorkSourcePool::removeWorkSource");
	var $spos = $s.length;
	this.worksources.remove(ws);
	$s.pop();
}
web2grid.core.work.WorkSourcePool.prototype.getWorkSources = function() {
	$s.push("web2grid.core.work.WorkSourcePool::getWorkSources");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkSourcePool.prototype.setTargetActive = function(num) {
	$s.push("web2grid.core.work.WorkSourcePool::setTargetActive");
	var $spos = $s.length;
	this.targetactive = num;
	$s.pop();
}
web2grid.core.work.WorkSourcePool.prototype.getNumActive = function() {
	$s.push("web2grid.core.work.WorkSourcePool::getNumActive");
	var $spos = $s.length;
	var active = 0;
	{
...
web2grid.core.work.WorkSourcePool.prototype.stepToNext = function() {
	$s.push("web2grid.core.work.WorkSourcePool::stepToNext");
	var $spos = $s.length;
	this.currentwsindex = (this.currentwsindex + 1) % this.worksources.length;
	$s.pop();
}
web2grid.core.work.WorkSourcePool.prototype.stepToPrev = function() {
	$s.push("web2grid.core.work.WorkSourcePool::stepToPrev");
	var $spos = $s.length;
...
web2grid.core.work.WorkSourcePool.prototype.terminate = function() {
	$s.push("web2grid.core.work.WorkSourcePool::terminate");
	var $spos = $s.length;
	var _g = 0, _g1 = this.worksources;
	while(_g < _g1.length) {
		var ws = _g1[_g];
...
web2grid.core.work.WorkSourcePool.prototype.isChanged = function() {
	$s.push("web2grid.core.work.WorkSourcePool::isChanged");
	var $spos = $s.length;
	{
		var _g = 0, _g1 = this.worksources;
		while(_g < _g1.length) {
...
web2grid.core.work.WorkSourcePool.prototype.hxSerialize = function(s) {
	$s.push("web2grid.core.work.WorkSourcePool::hxSerialize");
	var $spos = $s.length;
...
web2grid.core.work.WorkSourcePool.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.core.work.WorkSourcePool::hxUnserialize");
	var $spos = $s.length;
...
web2grid.core.work.WorkSourcePool.prototype.__class__ = web2grid.core.work.WorkSourcePool;
web2grid.core.work.WorkSourcePool.__interfaces__ = [web2grid.core.iface.Persistent,web2grid.core.iface.Operable];
...
web2grid.worksource.boinc.reply.SchedulerReply = function(node) { if( node === $_ ) return; {
	$s.push("web2grid.worksource.boinc.reply.SchedulerReply::new");
	var $spos = $s.length;
...
web2grid.core.iface.WorkUnitState = { __ename__ : ["web2grid","core","iface","WorkUnitState"], __constructs__ : ["Init","Passive","Active","Disabled","Completed"] }
web2grid.core.iface.WorkUnitState.Init = ["Init",0];
web2grid.core.iface.WorkUnitState.Init.toString = $estr;
web2grid.core.iface.WorkUnitState.Init.__enum__ = web2grid.core.iface.WorkUnitState;
web2grid.core.iface.WorkUnitState.Passive = ["Passive",1];
web2grid.core.iface.WorkUnitState.Passive.toString = $estr;
web2grid.core.iface.WorkUnitState.Passive.__enum__ = web2grid.core.iface.WorkUnitState;
web2grid.core.iface.WorkUnitState.Active = ["Active",2];
web2grid.core.iface.WorkUnitState.Active.toString = $estr;
web2grid.core.iface.WorkUnitState.Active.__enum__ = web2grid.core.iface.WorkUnitState;
web2grid.core.iface.WorkUnitState.Disabled = ["Disabled",3];
web2grid.core.iface.WorkUnitState.Disabled.toString = $estr;
web2grid.core.iface.WorkUnitState.Disabled.__enum__ = web2grid.core.iface.WorkUnitState;
web2grid.core.iface.WorkUnitState.Completed = ["Completed",4];
web2grid.core.iface.WorkUnitState.Completed.toString = $estr;
web2grid.core.iface.WorkUnitState.Completed.__enum__ = web2grid.core.iface.WorkUnitState;
...
web2grid.core.iface.WorkUnit.prototype.start = null;
web2grid.core.iface.WorkUnit.prototype.terminate = null;
web2grid.core.iface.WorkUnit.prototype.enable = null;
web2grid.core.iface.WorkUnit.prototype.disable = null;
web2grid.core.iface.WorkUnit.prototype.operate = null;
web2grid.core.iface.WorkUnit.prototype.getState = null;
web2grid.core.iface.WorkUnit.prototype.getStatusString = null;
web2grid.core.iface.WorkUnit.prototype.onProgressChange = null;
web2grid.core.iface.WorkUnit.prototype.onStatusChange = null;
web2grid.core.iface.WorkUnit.prototype.getScreenName = null;
web2grid.core.iface.WorkUnit.prototype.isChanged = null;
web2grid.core.iface.WorkUnit.prototype.isCompleted = null;
web2grid.core.iface.WorkUnit.prototype.isError = null;
web2grid.core.iface.WorkUnit.prototype.getError = null;
web2grid.core.iface.WorkUnit.prototype.getProgress = null;
web2grid.core.iface.WorkUnit.prototype.getResult = null;
web2grid.core.iface.WorkUnit.prototype.getElapsedTime = null;
web2grid.core.iface.WorkUnit.prototype.onComplete = null;
web2grid.core.iface.WorkUnit.prototype.onError = null;
web2grid.core.iface.WorkUnit.prototype.onProgress = null;
web2grid.core.iface.WorkUnit.prototype.__class__ = web2grid.core.iface.WorkUnit;
web2grid.core.iface.WorkUnit.__interfaces__ = [henkolib.async.AsyncResult,web2grid.core.iface.Persistent,henkolib.log.LogSource,web2grid.core.iface.Operable];
web2grid.worksource.boinc.request.Result = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.Result::new");
	var $spos = $s.length;
	this.file_info = new Array();
	$s.pop();
}}
...
web2grid.worksource.boinc.request.Result.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.Result::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
	var innerindent = indent + "    ";
...
web2grid.core.work.BasicWorkUnit = function(p) { if( p === $_ ) return; {
	...
	var $spos = $s.length;
	this.state = web2grid.core.iface.WorkUnitState.Init;
	this.context = new web2grid.core.work.WorkContext();
	this.init();
	$s.pop();
}}
...
web2grid.core.work.BasicWorkUnit.prototype.context = null;
web2grid.core.work.BasicWorkUnit.prototype.exe = null;
web2grid.core.work.BasicWorkUnit.prototype.operation = null;
web2grid.core.work.BasicWorkUnit.prototype.ares = null;
web2grid.core.work.BasicWorkUnit.prototype.onComplete = null;
...
web2grid.core.work.BasicWorkUnit.prototype.init = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::init");
	var $spos = $s.length;
...
web2grid.core.work.BasicWorkUnit.prototype.operate = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::operate");
	var $spos = $s.length;
	if(this.exe != null) this.exe.operate();
	$s.pop();
}
web2grid.core.work.BasicWorkUnit.prototype.start = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::start");
	var $spos = $s.length;
	if(this.state == web2grid.core.iface.WorkUnitState.Passive) {
		this.exe = new web2grid.core.work.WorkExecutor(this.context);
		...
		this.SwitchState(web2grid.core.iface.WorkUnitState.Active);
	}
	$s.pop();
}
web2grid.core.work.BasicWorkUnit.prototype.disable = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::disable");
	var $spos = $s.length;
	if(this.state == web2grid.core.iface.WorkUnitState.Active || this.state == web2grid.core.iface.WorkUnitState.Passive) {
		this.exe.terminate();
		this.SwitchState(web2grid.core.iface.WorkUnitState.Disabled);
	}
	$s.pop();
}
web2grid.core.work.BasicWorkUnit.prototype.enable = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::enable");
	var $spos = $s.length;
	if(this.state == web2grid.core.iface.WorkUnitState.Disabled) {
		this.SwitchState(web2grid.core.iface.WorkUnitState.Passive);
	}
	$s.pop();
}
web2grid.core.work.BasicWorkUnit.prototype.terminate = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::terminate");
	var $spos = $s.length;
	if(this.state == web2grid.core.iface.WorkUnitState.Active) {
		this.exe.terminate();
		this.SwitchState(web2grid.core.iface.WorkUnitState.Passive);
	}
	$s.pop();
}
web2grid.core.work.BasicWorkUnit.prototype.SwitchState = function(s) {
	$s.push("web2grid.core.work.BasicWorkUnit::SwitchState");
	var $spos = $s.length;
	this.state = s;
...
web2grid.core.work.BasicWorkUnit.prototype.getState = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getState");
	var $spos = $s.length;
	{
		var $tmp = this.state;
		$s.pop();
...
web2grid.core.work.BasicWorkUnit.prototype.getStatusString = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getStatusString");
	var $spos = $s.length;
	var $e = this.state;
	switch( $e[1] ) {
	case 2:
...
web2grid.core.work.BasicWorkUnit.prototype.getContext = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getContext");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.getScreenName = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getScreenName");
	var $spos = $s.length;
	{
		$s.pop();
...
web2grid.core.work.BasicWorkUnit.prototype.isChanged = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::isChanged");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.isCompleted = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::isCompleted");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.isError = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::isError");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.getError = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getError");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.getProgress = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getProgress");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.getResult = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getResult");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.getElapsedTime = function() {
	$s.push("web2grid.core.work.BasicWorkUnit::getElapsedTime");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkUnit.prototype.hxSerialize = function(s) {
	$s.push("web2grid.core.work.BasicWorkUnit::hxSerialize");
	var $spos = $s.length;
...
web2grid.core.work.BasicWorkUnit.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.core.work.BasicWorkUnit::hxUnserialize");
	var $spos = $s.length;
	this.state = s.unserialize();
	this.context = s.unserialize();
	if(this.state == web2grid.core.iface.WorkUnitState.Active) {
		this.state = web2grid.core.iface.WorkUnitState.Passive;
	}
	this.init();
	$s.pop();
}
web2grid.core.work.BasicWorkUnit.prototype.__class__ = web2grid.core.work.BasicWorkUnit;
web2grid.core.work.BasicWorkUnit.__interfaces__ = [henkolib.async.AsyncResult,web2grid.core.iface.WorkUnit];
Reflect = function() { }
...
web2grid.core.net.Downloader = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.core.net.Downloader::new");
	var $spos = $s.length;
	this.urls = new Array();
...
web2grid.core.net.Downloader.__name__ = ["web2grid","core","net","Downloader"];
web2grid.core.net.Downloader.databank = null;
web2grid.core.net.Downloader.prototype.urls = null;
web2grid.core.net.Downloader.prototype.dlurls = null;
web2grid.core.net.Downloader.prototype.requests = null;
web2grid.core.net.Downloader.prototype.data = null;
web2grid.core.net.Downloader.prototype.result = null;
web2grid.core.net.Downloader.prototype.add = function(url) {
	$s.push("web2grid.core.net.Downloader::add");
	var $spos = $s.length;
	this.urls.push(url);
	$s.pop();
}
web2grid.core.net.Downloader.prototype.downloadAll = function() {
	$s.push("web2grid.core.net.Downloader::downloadAll");
	var $spos = $s.length;
	var self = this;
	this.result = new henkolib.async.AsyncOperation();
	{
		...
		while(_g < _g1.length) {
			var url = _g1[_g];
			++_g;
			if(web2grid.core.net.Downloader.databank.exists(url)) {
				this.data.set(url,web2grid.core.net.Downloader.databank.get(url));
			}
			else {
	...
	}
	{
		...
		while(_g < _g1.length) {
			var url = [_g1[_g]];
			++_g;
			var req = web2grid.core.net.HTTPRequest.get(url[0]).send();
			req.onComplete.subscribe(function(url) {
				$s.push("web2grid.core.net.Downloader::downloadAll@67");
				var $spos = $s.length;
				{
					var $tmp = function(response) {
						$s.push("web2grid.core.net.Downloader::downloadAll@67@67");
						var $spos = $s.length;
						var fs = new web2grid.core.work.FileStream();
			...
			req.onError.subscribe(function() {
				$s.push("web2grid.core.net.Downloader::downloadAll@80");
				var $spos = $s.length;
				{
					var $tmp = function(error) {
						$s.push("web2grid.core.net.Downloader::downloadAll@80@80");
						var $spos = $s.length;
			...
			req.onProgress.subscribe(function() {
				$s.push("web2grid.core.net.Downloader::downloadAll@85");
				var $spos = $s.length;
				{
					var $tmp = function(progress) {
						$s.push("web2grid.core.net.Downloader::downloadAll@85@85");
						var $spos = $s.length;
						var sum = 0;
						{
							var _g2 = 0, _g3 = self.requests;
...
web2grid.core.net.Downloader.prototype.__class__ = web2grid.core.net.Downloader;
...
web2grid.worksource.boinc.request.AuthInfo = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.AuthInfo::new");
	var $spos = $s.length;
...
web2grid.worksource.boinc.request.AuthInfo.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.AuthInfo::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
	var xml = "";
...
web2grid.core.work.WorkExecutor = function(context) { if( context === $_ ) return; {
	$s.push("web2grid.core.work.WorkExecutor::new");
	var $spos = $s.length;
	this.context = context;
	this.temp = new web2grid.core.work.WorkContext();
	this.temp.copyFrom(context);
	this.running = false;
	$s.pop();
}}
web2grid.core.work.WorkExecutor.__name__ = ["web2grid","core","work","WorkExecutor"];
web2grid.core.work.WorkExecutor.prototype.worker = null;
web2grid.core.work.WorkExecutor.prototype.context = null;
web2grid.core.work.WorkExecutor.prototype.temp = null;
web2grid.core.work.WorkExecutor.prototype.running = null;
web2grid.core.work.WorkExecutor.prototype.start = null;
web2grid.core.work.WorkExecutor.prototype.lastchecktime = null;
web2grid.core.work.WorkExecutor.prototype.operation = null;
web2grid.core.work.WorkExecutor.prototype.operate = function() {
	$s.push("web2grid.core.work.WorkExecutor::operate");
	var $spos = $s.length;
	if(this.start && this.context.isAvailable()) {
		this.start = false;
		this.worker = new web2grid.js.Worker("worker.js");
...
web2grid.core.work.WorkExecutor.prototype.send = function(command,data) {
	$s.push("web2grid.core.work.WorkExecutor::send");
	var $spos = $s.length;
	if(this.worker != null) {
...
web2grid.core.work.WorkExecutor.prototype.run = function() {
	$s.push("web2grid.core.work.WorkExecutor::run");
	var $spos = $s.length;
	this.operation = new henkolib.async.AsyncOperation();
	this.start = true;
	this.operate();
...
web2grid.core.work.WorkExecutor.prototype.terminate = function() {
	$s.push("web2grid.core.work.WorkExecutor::terminate");
	var $spos = $s.length;
...
web2grid.core.work.WorkExecutor.prototype.onerror = function(event) {
	$s.push("web2grid.core.work.WorkExecutor::onerror");
	var $spos = $s.length;
	this.temp.log(henkolib.log.LogLevel.L1_Error,"worker error: " + event.message,event,null,{ fileName : "WorkExecutor.hx", lineNumber : 82, className : "web2grid.core.work.WorkExecutor", methodName : "onerror"});
	this.operation.setError("worker error: " + event.message);
	$s.pop();
}
web2grid.core.work.WorkExecutor.prototype.onmessage = function(event) {
	$s.push("web2grid.core.work.WorkExecutor::onmessage");
	var $spos = $s.length;
	...
	if(command == "exception") {
		this.temp.log(henkolib.log.LogLevel.L1_Error,data.type + " error",data.exception,null,{ fileName : "WorkExecutor.hx", lineNumber : 108, className : "web2grid.core.work.WorkExecutor", methodName : "onmessage"});
		this.context.copyFrom(this.temp);
		this.terminate();
	...
	if(command == "debug") {
		this.temp.log(henkolib.log.LogLevel.L5_Debug,"Debug",data,null,{ fileName : "WorkExecutor.hx", lineNumber : 139, className : "web2grid.core.work.WorkExecutor", methodName : "onmessage"});
	}
	$s.pop();
}
...
web2grid.worksource.boinc.request.HostInfo = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.HostInfo::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
web2grid.worksource.boinc.request.HostInfo.__name__ = ["web2grid","worksource","boinc","request","HostInfo"];
web2grid.worksource.boinc.request.HostInfo.updateHostInfo = function(hostinfo) {
	$s.push("web2grid.worksource.boinc.request.HostInfo::updateHostInfo");
	var $spos = $s.length;
...
web2grid.worksource.boinc.request.HostInfo.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.HostInfo::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
...
web2grid.worksource.boinc.request.ClientVersion = function(major,minor,release) { if( major === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.ClientVersion::new");
	var $spos = $s.length;
...
web2grid.worksource.boinc.request.ClientVersion.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.ClientVersion::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
	var xml = "";
...
web2grid.core.iface.WorkSource.prototype.getWorkUnits = null;
web2grid.core.iface.WorkSource.prototype.start = null;
web2grid.core.iface.WorkSource.prototype.terminate = null;
web2grid.core.iface.WorkSource.prototype.operate = null;
web2grid.core.iface.WorkSource.prototype.getNumActive = null;
web2grid.core.iface.WorkSource.prototype.startOne = null;
web2grid.core.iface.WorkSource.prototype.terminateOne = null;
web2grid.core.iface.WorkSource.prototype.onAddWorkunit = null;
web2grid.core.iface.WorkSource.prototype.onRemoveWorkunit = null;
web2grid.core.iface.WorkSource.prototype.getScreenName = null;
web2grid.core.iface.WorkSource.prototype.isChanged = null;
web2grid.core.iface.WorkSource.prototype.hxSerialize = null;
web2grid.core.iface.WorkSource.prototype.hxUnserialize = null;
web2grid.core.iface.WorkSource.prototype.__class__ = web2grid.core.iface.WorkSource;
web2grid.core.iface.WorkSource.__interfaces__ = [web2grid.core.iface.Persistent,henkolib.log.LogSource,web2grid.core.iface.Operable];
web2grid.core.work.BasicWorkSource = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.core.work.BasicWorkSource::new");
	var $spos = $s.length;
	this.workpool = new web2grid.core.work.WorkUnitPool();
	this.init();
	$s.pop();
}}
web2grid.core.work.BasicWorkSource.__name__ = ["web2grid","core","work","BasicWorkSource"];
web2grid.core.work.BasicWorkSource.prototype.workpool = null;
web2grid.core.work.BasicWorkSource.prototype.isRunning = null;
web2grid.core.work.BasicWorkSource.prototype.onaddworkunit = null;
web2grid.core.work.BasicWorkSource.prototype.onremoveworkunit = null;
web2grid.core.work.BasicWorkSource.prototype.onAddWorkunit = null;
web2grid.core.work.BasicWorkSource.prototype.onRemoveWorkunit = null;
web2grid.core.work.BasicWorkSource.prototype.init = function() {
	$s.push("web2grid.core.work.BasicWorkSource::init");
	var $spos = $s.length;
...
web2grid.core.work.BasicWorkSource.prototype.getWorkUnits = function() {
	$s.push("web2grid.core.work.BasicWorkSource::getWorkUnits");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkSource.prototype.start = function() {
	$s.push("web2grid.core.work.BasicWorkSource::start");
	var $spos = $s.length;
	this.isRunning = true;
	$s.pop();
}
web2grid.core.work.BasicWorkSource.prototype.terminate = function() {
	$s.push("web2grid.core.work.BasicWorkSource::terminate");
	var $spos = $s.length;
	this.isRunning = false;
	this.workpool.terminateAll();
	$s.pop();
}
web2grid.core.work.BasicWorkSource.prototype.operate = function() {
	$s.push("web2grid.core.work.BasicWorkSource::operate");
	var $spos = $s.length;
	if(this.isRunning) {
...
web2grid.core.work.BasicWorkSource.prototype.getNumActive = function() {
	$s.push("web2grid.core.work.BasicWorkSource::getNumActive");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkSource.prototype.startOne = function() {
	$s.push("web2grid.core.work.BasicWorkSource::startOne");
	var $spos = $s.length;
	this.isRunning = true;
	this.workpool.startOne();
	$s.pop();
}
web2grid.core.work.BasicWorkSource.prototype.terminateOne = function() {
	$s.push("web2grid.core.work.BasicWorkSource::terminateOne");
	var $spos = $s.length;
	this.workpool.terminateOne();
	$s.pop();
}
web2grid.core.work.BasicWorkSource.prototype.getScreenName = function() {
	$s.push("web2grid.core.work.BasicWorkSource::getScreenName");
	var $spos = $s.length;
	{
		$s.pop();
...
web2grid.core.work.BasicWorkSource.prototype.isChanged = function() {
	$s.push("web2grid.core.work.BasicWorkSource::isChanged");
	var $spos = $s.length;
	{
...
web2grid.core.work.BasicWorkSource.prototype.hxSerialize = function(s) {
	$s.push("web2grid.core.work.BasicWorkSource::hxSerialize");
	var $spos = $s.length;
	s.serialize(this.workpool);
	$s.pop();
}
web2grid.core.work.BasicWorkSource.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.core.work.BasicWorkSource::hxUnserialize");
	var $spos = $s.length;
	this.workpool = s.unserialize();
	this.init();
	$s.pop();
}
web2grid.core.work.BasicWorkSource.prototype.__class__ = web2grid.core.work.BasicWorkSource;
web2grid.core.work.BasicWorkSource.__interfaces__ = [web2grid.core.iface.WorkSource];
...
web2grid.worksource.boinc.request.SchedulerRequest = function(platform) { if( platform === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.SchedulerRequest::new");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincWorkSource = function(scheduler_url,authkey) { if( scheduler_url === $_ ) return; {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::new");
	var $spos = $s.length;
	...
	this.benchmarkpool = new web2grid.core.work.WorkUnitPool();
	this.uploader = new web2grid.worksource.boinc.BoincUploaderPool();
	this.host = new web2grid.worksource.boinc.request.Host();
	this.host.host_info.p_fpops = 0;
	this.host.host_info.p_iops = 0;
	web2grid.core.work.BasicWorkSource.call(this);
	$s.pop();
}}
web2grid.worksource.boinc.BoincWorkSource.__name__ = ["web2grid","worksource","boinc","BoincWorkSource"];
web2grid.worksource.boinc.BoincWorkSource.__super__ = web2grid.core.work.BasicWorkSource;
for(var k in web2grid.core.work.BasicWorkSource.prototype ) web2grid.worksource.boinc.BoincWorkSource.prototype[k] = web2grid.core.work.BasicWorkSource.prototype[k];
web2grid.worksource.boinc.BoincWorkSource.version = null;
web2grid.worksource.boinc.BoincWorkSource.platform = null;
web2grid.worksource.boinc.BoincWorkSource.getVersion = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::getVersion");
	var $spos = $s.length;
	{
		var $tmp = web2grid.worksource.boinc.BoincWorkSource.version;
		$s.pop();
		return $tmp;
	}
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkSource.prototype.projecturl = null;
web2grid.worksource.boinc.BoincWorkSource.prototype.projectname = null;
web2grid.worksource.boinc.BoincWorkSource.prototype.username = null;
...
web2grid.worksource.boinc.BoincWorkSource.prototype.uploadqueue = null;
web2grid.worksource.boinc.BoincWorkSource.prototype.reportqueue = null;
web2grid.worksource.boinc.BoincWorkSource.prototype.benchmarkpool = null;
web2grid.worksource.boinc.BoincWorkSource.prototype.requestinprogress = null;
web2grid.worksource.boinc.BoincWorkSource.prototype.uploader = null;
web2grid.worksource.boinc.BoincWorkSource.prototype.init = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::init");
	var $spos = $s.length;
	web2grid.core.work.BasicWorkSource.prototype.init.call(this);
	this.updateHostInfo();
	this.uploader.onUpload.subscribe($closure(this,"wuUploaded"));
	if(this.host.host_info.p_fpops == 0) {
		this.benchmarkpool = new web2grid.core.work.WorkUnitPool();
		var benchmark = new web2grid.worksource.boinc.benchmark.WhetstoneBenchmark();
		var self = this;
		benchmark.onComplete.subscribe(function(c) {
			$s.push("web2grid.worksource.boinc.BoincWorkSource::init@103");
			var $spos = $s.length;
			self.host.host_info.p_fpops = benchmark.getFlops();
			self.updateHostInfo();
			self.benchmarkpool.removeCompleted();
			henkolib.log.Console.main.logInformation("Benchmark successfully executed.",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 108, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "init"});
			$s.pop();
		});
		benchmark.onError.subscribe(function(e) {
			$s.push("web2grid.worksource.boinc.BoincWorkSource::init@110");
			var $spos = $s.length;
			henkolib.log.Console.main.logError("Benchmark error: " + e,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 112, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "init"});
			self.benchmarkpool.removeCompleted();
			$s.pop();
		});
...
web2grid.worksource.boinc.BoincWorkSource.prototype.isChanged = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::isChanged");
	var $spos = $s.length;
	{
		var $tmp = web2grid.core.work.BasicWorkSource.prototype.isChanged.call(this) || this.benchmarkpool.isChanged() || this.uploader.isChanged();
		$s.pop();
		return $tmp;
	}
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkSource.prototype.startOne = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::startOne");
	var $spos = $s.length;
	if(this.host.host_info.p_fpops != 0) {
		if(this.workpool.getNumInit() + this.workpool.getNumPassive() == 0 && !this.requestinprogress) {
			...
			newworks.onComplete.subscribe(function(wus) {
				$s.push("web2grid.worksource.boinc.BoincWorkSource::startOne@135");
				var $spos = $s.length;
				var _g = 0;
				while(_g < wus.length) {
					var wu = wus[_g];
					...
					henkolib.log.Console.main.logInformation("Workunit added to pool",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 141, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "startOne"});
				}
				$s.pop();
			});
			newworks.onError.subscribe(function(errormes) {
				$s.push("web2grid.worksource.boinc.BoincWorkSource::startOne@145");
				var $spos = $s.length;
				henkolib.log.Console.main.logNotice(errormes,null,null,{ fileName : "BoincWorkSource.hx", lineNumber : 147, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "startOne"});
				$s.pop();
			});
		}
		web2grid.core.work.BasicWorkSource.prototype.startOne.call(this);
	}
	else {
...
web2grid.worksource.boinc.BoincWorkSource.prototype.getSchedulerUrl = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::getSchedulerUrl");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkSource.prototype.getAuthkey = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::getAuthkey");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkSource.prototype.updateHostInfo = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::updateHostInfo");
	var $spos = $s.length;
	web2grid.worksource.boinc.request.HostInfo.updateHostInfo(this.host.host_info);
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkSource.prototype.getScreenName = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::getScreenName");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkSource.prototype.operate = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::operate");
	var $spos = $s.length;
	web2grid.core.work.BasicWorkSource.prototype.operate.call(this);
...
web2grid.worksource.boinc.BoincWorkSource.prototype.wuUploaded = function(wu) {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::wuUploaded");
	var $spos = $s.length;
	this.reportWork(wu);
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkSource.prototype.requestWorks = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::requestWorks");
	var $spos = $s.length;
	this.requestinprogress = true;
	var request = new web2grid.worksource.boinc.request.SchedulerRequest(web2grid.worksource.boinc.BoincWorkSource.platform);
	request.setClientVersion(web2grid.worksource.boinc.BoincWorkSource.version);
	request.setPlatform(web2grid.worksource.boinc.BoincWorkSource.platform);
	...
	request.setWorkRequest(new web2grid.worksource.boinc.request.WorkRequest(10));
	{
		...
		while(_g < _g1.length) {
			var work = _g1[_g];
			++_g;
			henkolib.log.Console.main.logInformation("Reporting uploaded results to: " + this.getScreenName(),null,work,{ fileName : "BoincWorkSource.hx", lineNumber : 212, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
	...
	http.errorCallback(function(error) {
		$s.push("web2grid.worksource.boinc.BoincWorkSource::requestWorks@221");
		var $spos = $s.length;
	...
	http.successCallback(function(response) {
		$s.push("web2grid.worksource.boinc.BoincWorkSource::requestWorks@222");
		var $spos = $s.length;
		henkolib.log.Console.main.logInformation("Received Boinc Scheduler reply.",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 224, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		...
		if(reply.hostid != null) {
			...
			henkolib.log.Console.main.logNotice("Registered new host: " + reply.hostid,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 234, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			henkolib.log.Console.main.logNotice("Project name: " + reply.project_name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 235, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			henkolib.log.Console.main.logNotice("Username: " + reply.user_name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 236, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		}
		{
			...
			while(_g < _g1.length) {
				var ack = _g1[_g];
				++_g;
				henkolib.log.Console.main.logInformation("Received result ack: " + ack.name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 244, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
				{
					...
					while(_g2 < _g3.length) {
						...
						if(work.getWorkUnitResultName() == ack.name) {
							...
							henkolib.log.Console.main.logNotice("Reported result accepted. WorkUnit removed.",null,work,{ fileName : "BoincWorkSource.hx", lineNumber : 250, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		...
		}
		{
			...
			while(_g < _g1.length) {
				var message = _g1[_g];
				++_g;
				henkolib.log.Console.main.logNotice("BOINC " + message.priority + " priority message: " + message.message,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 261, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			}
		}
		var workunits = new Array();
		{
			...
			while(_g < _g1.length) {
				...
				var bwu = new web2grid.worksource.boinc.BoincWorkUnit(unit);
				workunits.push(bwu);
			}
		}
	...
	henkolib.log.Console.main.logInformation("Sending Boinc Scheduler request.",null,this,{ fileName : "BoincWorkSource.hx", lineNumber : 334, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
	http.send();
	{
		$s.pop();
		return result;
...
web2grid.worksource.boinc.BoincWorkSource.prototype.reportWork = function(work) {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::reportWork");
	var $spos = $s.length;
	henkolib.log.Console.main.logInformation("Added to reporting queue: " + work.getScreenName(),null,this,{ fileName : "BoincWorkSource.hx", lineNumber : 342, className : "web2grid.worksource.boinc.BoincWorkSource", methodName : "reportWork"});
	this.reportqueue.push(work);
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkSource.prototype.hxSerialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::hxSerialize");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincWorkSource.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincWorkSource::hxUnserialize");
	var $spos = $s.length;
...
web2grid.worksource.boinc.reply.ResultAck = function(node) { if( node === $_ ) return; {
	$s.push("web2grid.worksource.boinc.reply.ResultAck::new");
	var $spos = $s.length;
	if(node.hasNode.resolve("name")) this.name = node.node.resolve("name").getInnerData();
	$s.pop();
}}
...
web2grid.worksource.boinc.request.DataServerRequest = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.DataServerRequest::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
...
web2grid.worksource.boinc.request.DataServerRequest.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.DataServerRequest::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
...
web2grid.worksource.boinc.reply.Application = function(node) { if( node === $_ ) return; {
	$s.push("web2grid.worksource.boinc.reply.Application::new");
	var $spos = $s.length;
	if(node.hasNode.resolve("name")) this.name = node.node.resolve("name").getInnerData();
...
web2grid.worksource.boinc.request.WorkRequest = function(required_seconds) { if( required_seconds === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.WorkRequest::new");
	var $spos = $s.length;
...
web2grid.worksource.boinc.request.WorkRequest.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.WorkRequest::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
	var xml = "";
...
web2grid.js.MessageEvent.prototype.origin = null;
web2grid.js.MessageEvent.prototype.lastEventId = null;
web2grid.js.MessageEvent.prototype.__class__ = web2grid.js.MessageEvent;
web2grid.js.MessageEvent.__interfaces__ = [web2grid.js.Event];
web2grid.js.ErrorEvent = function() { }
web2grid.js.ErrorEvent.__name__ = ["web2grid","js","ErrorEvent"];
web2grid.js.ErrorEvent.prototype.message = null;
web2grid.js.ErrorEvent.prototype.filename = null;
web2grid.js.ErrorEvent.prototype.lineno = null;
web2grid.js.ErrorEvent.prototype.__class__ = web2grid.js.ErrorEvent;
web2grid.js.ErrorEvent.__interfaces__ = [web2grid.js.Event];
...
web2grid.worksource.boinc.reply.FileInfo = function(node) { if( node === $_ ) return; {
	$s.push("web2grid.worksource.boinc.reply.FileInfo::new");
	var $spos = $s.length;
	if(node.hasNode.resolve("name")) this.name = node.node.resolve("name").getInnerData();
...
web2grid.worksource.boinc.BoincResult = function(workunit,slot,fileref,data) { if( workunit === $_ ) return; {
	$s.push("web2grid.worksource.boinc.BoincResult::new");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincResult.prototype.changed = null;
...
web2grid.worksource.boinc.BoincResult.prototype.isCompleted = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::isCompleted");
	var $spos = $s.length;
	{
		var $tmp = this.state == web2grid.worksource.boinc.BoincResultState.Uploaded;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.worksource.boinc.BoincResult.prototype.isError = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::isError");
	var $spos = $s.length;
	{
		var $tmp = this.state == web2grid.worksource.boinc.BoincResultState.Error;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.worksource.boinc.BoincResult.prototype.SwitchState = function(newstate) {
	$s.push("web2grid.worksource.boinc.BoincResult::SwitchState");
	var $spos = $s.length;
	this.changed = true;
	this.state = newstate;
	henkolib.log.Console.main.logDebug("Changed state to " + this.getState(),null,this,{ fileName : "BoincResult.hx", lineNumber : 74, className : "web2grid.worksource.boinc.BoincResult", methodName : "SwitchState"});
	$s.pop();
}
web2grid.worksource.boinc.BoincResult.prototype.getScreenName = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::getScreenName");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincResult.prototype.getStateString = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::getStateString");
	var $spos = $s.length;
	var $e = this.state;
	switch( $e[1] ) {
	case 0:
...
web2grid.worksource.boinc.BoincResult.prototype.isChanged = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::isChanged");
	var $spos = $s.length;
	{
		var $tmp = this.changed;
		$s.pop();
...
web2grid.worksource.boinc.BoincResult.prototype.getState = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::getState");
	var $spos = $s.length;
	{
		var $tmp = this.state;
		$s.pop();
...
web2grid.worksource.boinc.BoincResult.prototype.operate = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::operate");
	var $spos = $s.length;
	var $e = this.state;
	switch( $e[1] ) {
	case 0:
	{
		{
			henkolib.log.Console.main.logInformation("Checking upload status.",null,this,{ fileName : "BoincResult.hx", lineNumber : 112, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
			...
			if(this.statusCheckOperation.isCompleted()) {
				...
				if(reply.status == 0) {
					if(reply.file_size == 0) {
						henkolib.log.Console.main.logInformation("This result is not uploaded yet.",null,this,{ fileName : "BoincResult.hx", lineNumber : 129, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
						this.SwitchState(web2grid.worksource.boinc.BoincResultState.ReadyToUpload);
					}
					else {
						henkolib.log.Console.main.logInformation("This result has been already uploaded.",null,this,{ fileName : "BoincResult.hx", lineNumber : 135, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
						this.SwitchState(web2grid.worksource.boinc.BoincResultState.Uploaded);
					}
				}
				else {
					henkolib.log.Console.main.logWarning("Could not retrieve result status.",null,this,{ fileName : "BoincResult.hx", lineNumber : 141, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
	...
	{
		{
			henkolib.log.Console.main.logInformation("Uploading: " + this.data.length + " bytes",null,this,{ fileName : "BoincResult.hx", lineNumber : 149, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
			this.uploadOperation = this.uploadResult(this.fileref,this.data,this.md5);
	...
	{
		{
			if(this.uploadOperation.isCompleted()) {
				...
				if(reply.message != null) {
					henkolib.log.Console.main.logWarning("Upload handler message: " + reply.message,null,this,{ fileName : "BoincResult.hx", lineNumber : 164, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
				}
				if(reply.status == 0) {
					henkolib.log.Console.main.logInformation("Uploaded successfully.",null,this,{ fileName : "BoincResult.hx", lineNumber : 169, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
					this.SwitchState(web2grid.worksource.boinc.BoincResultState.Uploaded);
				}
				else {
					henkolib.log.Console.main.logWarning("Could not upload result.",null,this,{ fileName : "BoincResult.hx", lineNumber : 174, className : "web2grid.worksource.boinc.BoincResult", methodName : "operate"});
					this.SwitchState(web2grid.worksource.boinc.BoincResultState.Error);
				}
			}
		}
...
web2grid.worksource.boinc.BoincResult.prototype.getFileInfo = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::getFileInfo");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincResult.prototype.isAccepted = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::isAccepted");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincResult.prototype.setAccepted = function() {
	$s.push("web2grid.worksource.boinc.BoincResult::setAccepted");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincResult.prototype.checkUploadStatus = function(fileref) {
	$s.push("web2grid.worksource.boinc.BoincResult::checkUploadStatus");
	var $spos = $s.length;
	var request = new web2grid.worksource.boinc.request.DataServerRequest();
	request.clientversion = web2grid.worksource.boinc.BoincWorkSource.getVersion();
...
web2grid.worksource.boinc.BoincResult.prototype.uploadResult = function(fileref,data,md5) {
	$s.push("web2grid.worksource.boinc.BoincResult::uploadResult");
	var $spos = $s.length;
	var request = new web2grid.worksource.boinc.request.DataServerRequest();
	request.clientversion = web2grid.worksource.boinc.BoincWorkSource.getVersion();
...
web2grid.worksource.boinc.BoincResult.prototype.hxSerialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincResult::hxSerialize");
	var $spos = $s.length;
	s.serialize(this.state);
...
web2grid.worksource.boinc.BoincResult.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincResult::hxUnserialize");
	var $spos = $s.length;
	this.state = s.unserialize();
	...
	if(this.state == web2grid.worksource.boinc.BoincResultState.Uploading) this.state = web2grid.worksource.boinc.BoincResultState.New;
	$s.pop();
}
web2grid.worksource.boinc.BoincResult.prototype.__class__ = web2grid.worksource.boinc.BoincResult;
web2grid.worksource.boinc.BoincResult.__interfaces__ = [henkolib.log.LogSource,web2grid.core.iface.Operable];
web2grid.worksource.boinc.reply.FileRef = function(node) { if( node === $_ ) return; {
	$s.push("web2grid.worksource.boinc.reply.FileRef::new");
	var $spos = $s.length;
...
Main.onload = function() {
	...
	Main.gbClient.setTargetActive(1);
	$s.pop();
}
Main.onLog = function(entry) {
	$s.push("Main::onLog");
	var $spos = $s.length;
	var html = henkolib.log.Console.main.exportAsHtml(100,henkolib.log.LogLevel.L4_Information);
	var scrolling = false;
...
if(!web2grid.worksource.boinc.benchmark) web2grid.worksource.boinc.benchmark = {}
web2grid.worksource.boinc.benchmark.WhetstoneBenchmark = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.benchmark.WhetstoneBenchmark::new");
	var $spos = $s.length;
	web2grid.core.work.BasicWorkUnit.call(this);
...
web2grid.worksource.boinc.benchmark.WhetstoneBenchmark.__name__ = ["web2grid","worksource","boinc","benchmark","WhetstoneBenchmark"];
web2grid.worksource.boinc.benchmark.WhetstoneBenchmark.__super__ = web2grid.core.work.BasicWorkUnit;
for(var k in web2grid.core.work.BasicWorkUnit.prototype ) web2grid.worksource.boinc.benchmark.WhetstoneBenchmark.prototype[k] = web2grid.core.work.BasicWorkUnit.prototype[k];
web2grid.worksource.boinc.benchmark.WhetstoneBenchmark.prototype.getFlops = function() {
	$s.push("web2grid.worksource.boinc.benchmark.WhetstoneBenchmark::getFlops");
	var $spos = $s.length;
...
web2grid.worksource.boinc.benchmark.WhetstoneBenchmark.prototype.__class__ = web2grid.worksource.boinc.benchmark.WhetstoneBenchmark;
if(!web2grid.core.control) web2grid.core.control = {}
web2grid.core.control.Client = function(savepath) { if( savepath === $_ ) return; {
	$s.push("web2grid.core.control.Client::new");
	var $spos = $s.length;
	this.timer = null;
...
web2grid.core.control.Client.__name__ = ["web2grid","core","control","Client"];
...
web2grid.core.control.Client.prototype.stop = function() {
	$s.push("web2grid.core.control.Client::stop");
	var $spos = $s.length;
	this.terminate();
	$s.pop();
}
web2grid.core.control.Client.prototype.terminate = function() {
	$s.push("web2grid.core.control.Client::terminate");
	var $spos = $s.length;
	if(this.timer != null) {
...
web2grid.core.control.Client.prototype.setThreadNumber = function(n) {
	$s.push("web2grid.core.control.Client::setThreadNumber");
	var $spos = $s.length;
	this.worksourcepool.setTargetActive(n);
	$s.pop();
}
web2grid.core.control.Client.prototype.onrun = function() {
	$s.push("web2grid.core.control.Client::onrun");
	var $spos = $s.length;
...
web2grid.core.control.Client.prototype.addWorksource = function(worksource) {
	$s.push("web2grid.core.control.Client::addWorksource");
	var $spos = $s.length;
	this.worksourcepool.addWorkSource(worksource);
	$s.pop();
}
web2grid.core.control.Client.prototype.removeWorksource = function(worksource) {
	$s.push("web2grid.core.control.Client::removeWorksource");
	var $spos = $s.length;
	this.worksourcepool.removeWorkSource(worksource);
	$s.pop();
}
web2grid.core.control.Client.prototype.getWorksources = function() {
	$s.push("web2grid.core.control.Client::getWorksources");
	var $spos = $s.length;
	{
...
web2grid.core.control.Client.prototype.addBoincWorkSource = function(scheduler_url,authkey) {
	$s.push("web2grid.core.control.Client::addBoincWorkSource");
	var $spos = $s.length;
	this.worksourcepool.addWorkSource(new web2grid.worksource.boinc.BoincWorkSource(scheduler_url,authkey));
	$s.pop();
}
web2grid.core.control.Client.prototype.setTargetActive = function(num) {
	$s.push("web2grid.core.control.Client::setTargetActive");
	var $spos = $s.length;
	this.worksourcepool.setTargetActive(num);
	$s.pop();
}
web2grid.core.control.Client.prototype.save = function() {
	$s.push("web2grid.core.control.Client::save");
	var $spos = $s.length;
...
web2grid.core.control.Client.prototype.restore = function() {
	$s.push("web2grid.core.control.Client::restore");
	var $spos = $s.length;
	try {
		...
		if(string == null || string == "") {
			...
			this.worksourcepool = (function($this) {
				...
				if(Std["is"]($t,web2grid.core.work.WorkSourcePool)) $t;
...
web2grid.worksource.boinc.BoincUploader = function(wu) { if( wu === $_ ) return; {
	$s.push("web2grid.worksource.boinc.BoincUploader::new");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincUploader.__name__ = ["web2grid","worksource","boinc","BoincUploader"];
web2grid.worksource.boinc.BoincUploader.prototype.workunit = null;
web2grid.worksource.boinc.BoincUploader.prototype.boincworkunit = null;
web2grid.worksource.boinc.BoincUploader.prototype.context = null;
web2grid.worksource.boinc.BoincUploader.prototype.results = null;
web2grid.worksource.boinc.BoincUploader.prototype.status = null;
web2grid.worksource.boinc.BoincUploader.prototype.uploadAll = function() {
	$s.push("web2grid.worksource.boinc.BoincUploader::uploadAll");
	var $spos = $s.length;
	this.boincworkunit.setUploadingState();
	henkolib.log.Console.main.logNotice("Uploading results.",null,null,{ fileName : "BoincUploader.hx", lineNumber : 37, className : "web2grid.worksource.boinc.BoincUploader", methodName : "uploadAll"});
			...
			var ok = false;
			{
				...
				while(_g1 < _g2.length) {
					...
					if(ref.open_name == stream) {
						this.results.push(new web2grid.worksource.boinc.BoincResult(this.boincworkunit,this.workunit.result,ref,this.context.read(ref.open_name)));
						ok = true;
					}
				}
			}
...
web2grid.worksource.boinc.BoincUploader.prototype.isChanged = function() {
	$s.push("web2grid.worksource.boinc.BoincUploader::isChanged");
	var $spos = $s.length;
	{
		var _g = 0, _g1 = this.results;
		while(_g < _g1.length) {
...
web2grid.worksource.boinc.BoincUploader.prototype.isCompleted = function() {
	$s.push("web2grid.worksource.boinc.BoincUploader::isCompleted");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincUploader.prototype.getResult = function() {
	$s.push("web2grid.worksource.boinc.BoincUploader::getResult");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincUploader.prototype.operate = function() {
	$s.push("web2grid.worksource.boinc.BoincUploader::operate");
	var $spos = $s.length;
	{
		var _g = 0, _g1 = this.results;
		while(_g < _g1.length) {
...
web2grid.worksource.boinc.BoincUploader.prototype.__class__ = web2grid.worksource.boinc.BoincUploader;
js.Lib = function() { }
...
web2grid.core.info.BrowserInfo = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.core.info.BrowserInfo::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
...
web2grid.core.info.BrowserInfo.detectBrowser = function() {
	$s.push("web2grid.core.info.BrowserInfo::detectBrowser");
	var $spos = $s.length;
	var success;
	success = web2grid.core.info.BrowserInfo.checkBrowser("Opera Software","Opera",function(navigator) {
		$s.push("web2grid.core.info.BrowserInfo::detectBrowser@44");
		var $spos = $s.length;
		{
	...
	success = web2grid.core.info.BrowserInfo.checkBrowser("Microsoft","Internet Explorer",function(navigator) {
		$s.push("web2grid.core.info.BrowserInfo::detectBrowser@50");
		var $spos = $s.length;
		{
	...
	success = web2grid.core.info.BrowserInfo.checkBrowser("Google","Chrome",function(navigator) {
		$s.push("web2grid.core.info.BrowserInfo::detectBrowser@56");
		var $spos = $s.length;
		{
	...
	success = web2grid.core.info.BrowserInfo.checkBrowser("Mozilla","Firefox",function(navigator) {
		$s.push("web2grid.core.info.BrowserInfo::detectBrowser@62");
		var $spos = $s.length;
		{
...
web2grid.core.info.BrowserInfo.checkBrowser = function(vendor,browser,check,versionRegexp) {
	$s.push("web2grid.core.info.BrowserInfo::checkBrowser");
	var $spos = $s.length;
...
web2grid.core.info.BrowserInfo.browserVendor = function() {
	$s.push("web2grid.core.info.BrowserInfo::browserVendor");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.browserVendorValue == null) web2grid.core.info.BrowserInfo.detectBrowser();
	{
		var $tmp = web2grid.core.info.BrowserInfo.browserVendorValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.browserName = function() {
	$s.push("web2grid.core.info.BrowserInfo::browserName");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.browserNameValue == null) web2grid.core.info.BrowserInfo.detectBrowser();
	{
		var $tmp = web2grid.core.info.BrowserInfo.browserNameValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.browserFullVersion = function() {
	$s.push("web2grid.core.info.BrowserInfo::browserFullVersion");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.browserFullVersionValue == null) web2grid.core.info.BrowserInfo.detectBrowser();
	{
		var $tmp = web2grid.core.info.BrowserInfo.browserFullVersionValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.browserMajorVersion = function() {
	$s.push("web2grid.core.info.BrowserInfo::browserMajorVersion");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.browserMajorVersionValue == null) web2grid.core.info.BrowserInfo.detectBrowser();
	{
		var $tmp = web2grid.core.info.BrowserInfo.browserMajorVersionValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.detectOs = function() {
	$s.push("web2grid.core.info.BrowserInfo::detectOs");
	var $spos = $s.length;
	var r;
...
web2grid.core.info.BrowserInfo.osPlatform = function() {
	$s.push("web2grid.core.info.BrowserInfo::osPlatform");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.osPlatformValue == null) web2grid.core.info.BrowserInfo.detectOs();
	{
		var $tmp = web2grid.core.info.BrowserInfo.osPlatformValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.osName = function() {
	$s.push("web2grid.core.info.BrowserInfo::osName");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.osNameValue == null) web2grid.core.info.BrowserInfo.detectOs();
	{
		var $tmp = web2grid.core.info.BrowserInfo.osNameValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.detectFlash = function() {
	$s.push("web2grid.core.info.BrowserInfo::detectFlash");
	var $spos = $s.length;
...
web2grid.core.info.BrowserInfo.flashInstalled = function() {
	$s.push("web2grid.core.info.BrowserInfo::flashInstalled");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.flashInstalledValue == null) web2grid.core.info.BrowserInfo.detectFlash();
	{
		var $tmp = web2grid.core.info.BrowserInfo.flashInstalledValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.flashFullVersion = function() {
	$s.push("web2grid.core.info.BrowserInfo::flashFullVersion");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.flashFullVersionValue == null) web2grid.core.info.BrowserInfo.detectFlash();
	{
		var $tmp = web2grid.core.info.BrowserInfo.flashFullVersionValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.flashMajorVersion = function() {
	$s.push("web2grid.core.info.BrowserInfo::flashMajorVersion");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.flashMajorVersionValue == null) web2grid.core.info.BrowserInfo.detectFlash();
	{
		var $tmp = web2grid.core.info.BrowserInfo.flashMajorVersionValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.detectHtml5 = function() {
	$s.push("web2grid.core.info.BrowserInfo::detectHtml5");
	var $spos = $s.length;
...
web2grid.core.info.BrowserInfo.html5xmlHttpRequestLevel2 = function() {
	$s.push("web2grid.core.info.BrowserInfo::html5xmlHttpRequestLevel2");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.html5xmlHttpRequestLevel2Value == null) web2grid.core.info.BrowserInfo.detectHtml5();
	{
		var $tmp = web2grid.core.info.BrowserInfo.html5xmlHttpRequestLevel2Value;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.html5localStorage = function() {
	$s.push("web2grid.core.info.BrowserInfo::html5localStorage");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.html5localStorageValue == null) web2grid.core.info.BrowserInfo.detectHtml5();
	{
		var $tmp = web2grid.core.info.BrowserInfo.html5localStorageValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.html5webWorkers = function() {
	$s.push("web2grid.core.info.BrowserInfo::html5webWorkers");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.html5webWorkersValue == null) web2grid.core.info.BrowserInfo.detectHtml5();
	{
		var $tmp = web2grid.core.info.BrowserInfo.html5webWorkersValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.info.BrowserInfo.html5webSockets = function() {
	$s.push("web2grid.core.info.BrowserInfo::html5webSockets");
	var $spos = $s.length;
	if(web2grid.core.info.BrowserInfo.html5webSocketsValue == null) web2grid.core.info.BrowserInfo.detectHtml5();
	{
		var $tmp = web2grid.core.info.BrowserInfo.html5webSocketsValue;
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.net.HTTPResponse = function(statusCode,headers,content) { if( statusCode === $_ ) return; {
	$s.push("web2grid.core.net.HTTPResponse::new");
	var $spos = $s.length;
...
web2grid.core.net.HTTPRequest = function(method,url) { if( method === $_ ) return; {
	$s.push("web2grid.core.net.HTTPRequest::new");
	var $spos = $s.length;
...
web2grid.core.net.HTTPRequest.get = function(url) {
	$s.push("web2grid.core.net.HTTPRequest::get");
	var $spos = $s.length;
	{
		var $tmp = new web2grid.core.net.HTTPRequest("GET",url);
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.net.HTTPRequest.post = function(url) {
	$s.push("web2grid.core.net.HTTPRequest::post");
	var $spos = $s.length;
	{
		var $tmp = new web2grid.core.net.HTTPRequest("POST",url);
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.net.HTTPRequest.put = function(url) {
	$s.push("web2grid.core.net.HTTPRequest::put");
	var $spos = $s.length;
	{
		var $tmp = new web2grid.core.net.HTTPRequest("PUT",url);
		$s.pop();
		return $tmp;
	}
	$s.pop();
...
web2grid.core.net.HTTPRequest.prototype.send = function() {
	$s.push("web2grid.core.net.HTTPRequest::send");
	var $spos = $s.length;
...
web2grid.core.net.HTTPRequest.prototype.xhrOnReadyStateChange = function() {
	$s.push("web2grid.core.net.HTTPRequest::xhrOnReadyStateChange");
	var $spos = $s.length;
...
web2grid.core.net.HTTPRequest.prototype.xhr2UploadOnProgress = function(evt) {
	$s.push("web2grid.core.net.HTTPRequest::xhr2UploadOnProgress");
	var $spos = $s.length;
...
web2grid.core.net.HTTPRequest.prototype.xhr2OnProgress = function(evt) {
	$s.push("web2grid.core.net.HTTPRequest::xhr2OnProgress");
	var $spos = $s.length;
	if(evt.lengthComputable) {
		var progress = evt.loaded / evt.total;
...
web2grid.core.net.HTTPRequest.prototype.xhr2OnLoad = function(evt) {
	$s.push("web2grid.core.net.HTTPRequest::xhr2OnLoad");
	var $spos = $s.length;
...
web2grid.core.net.HTTPRequest.prototype.xhr2OnError = function(evt) {
	$s.push("web2grid.core.net.HTTPRequest::xhr2OnError");
	var $spos = $s.length;
	this.response.setError("Network error");
	$s.pop();
}
web2grid.core.net.HTTPRequest.prototype.xdrOnLoad = function() {
	$s.push("web2grid.core.net.HTTPRequest::xdrOnLoad");
	var $spos = $s.length;
	this.response.setProgress(1);
...
web2grid.core.net.HTTPRequest.prototype.errorCallback = function(errorCallback) {
	$s.push("web2grid.core.net.HTTPRequest::errorCallback");
	var $spos = $s.length;
...
web2grid.core.net.HTTPRequest.prototype.progressCallback = function(progressCallback) {
	$s.push("web2grid.core.net.HTTPRequest::progressCallback");
	var $spos = $s.length;
...
web2grid.core.work.BenchmarkWorkUnit = function(code) { if( code === $_ ) return; {
	$s.push("web2grid.core.work.BenchmarkWorkUnit::new");
	var $spos = $s.length;
	web2grid.core.work.BasicWorkUnit.call(this);
	this.context.setProgramCode(code);
	this.state = web2grid.core.iface.WorkUnitState.Passive;
...
web2grid.core.work.BenchmarkWorkUnit.__name__ = ["web2grid","core","work","BenchmarkWorkUnit"];
web2grid.core.work.BenchmarkWorkUnit.__super__ = web2grid.core.work.BasicWorkUnit;
for(var k in web2grid.core.work.BasicWorkUnit.prototype ) web2grid.core.work.BenchmarkWorkUnit.prototype[k] = web2grid.core.work.BasicWorkUnit.prototype[k];
web2grid.core.work.BenchmarkWorkUnit.prototype.code = null;
web2grid.core.work.BenchmarkWorkUnit.prototype.__class__ = web2grid.core.work.BenchmarkWorkUnit;
web2grid.core.work.FileStream = function(url,readonly) { if( url === $_ ) return; {
	$s.push("web2grid.core.work.FileStream::new");
	var $spos = $s.length;
	this.content = "";
	this.url = url;
...
web2grid.core.work.FileStream.__name__ = ["web2grid","core","work","FileStream"];
web2grid.core.work.FileStream.prototype.content = null;
web2grid.core.work.FileStream.prototype.created = null;
web2grid.core.work.FileStream.prototype.url = null;
web2grid.core.work.FileStream.prototype.readonly = null;
web2grid.core.work.FileStream.prototype.isavailable = null;
web2grid.core.work.FileStream.prototype.iserror = null;
web2grid.core.work.FileStream.prototype.changed = null;
web2grid.core.work.FileStream.prototype.init = function() {
	$s.push("web2grid.core.work.FileStream::init");
	var $spos = $s.length;
	if(this.url != null && this.isavailable != true) {
		var req = web2grid.core.net.HTTPRequest.get(this.url).send();
		var self = this;
		req.onComplete.subscribe(function(response) {
			$s.push("web2grid.core.work.FileStream::init@41");
			var $spos = $s.length;
		...
		req.onError.subscribe(function(r) {
			$s.push("web2grid.core.work.FileStream::init@47");
			var $spos = $s.length;
			self.iserror = true;
			$s.pop();
		});
...
web2grid.core.work.FileStream.prototype.write = function(s) {
	$s.push("web2grid.core.work.FileStream::write");
	var $spos = $s.length;
	this.content += s;
	if(!this.readonly) {
		this.changed = true;
...
web2grid.core.work.FileStream.prototype.setContent = function(s) {
	$s.push("web2grid.core.work.FileStream::setContent");
	var $spos = $s.length;
	this.content = s;
	if(!this.readonly) {
		this.changed = true;
...
web2grid.core.work.FileStream.prototype.getContent = function() {
	$s.push("web2grid.core.work.FileStream::getContent");
	var $spos = $s.length;
	{
...
web2grid.core.work.FileStream.prototype.getHash = function() {
	$s.push("web2grid.core.work.FileStream::getHash");
	var $spos = $s.length;
	{
...
web2grid.core.work.FileStream.prototype.getSize = function() {
	$s.push("web2grid.core.work.FileStream::getSize");
	var $spos = $s.length;
	{
...
web2grid.core.work.FileStream.prototype.getCreateDate = function() {
	$s.push("web2grid.core.work.FileStream::getCreateDate");
	var $spos = $s.length;
	{
...
web2grid.core.work.FileStream.prototype.copyFrom = function(stream) {
	$s.push("web2grid.core.work.FileStream::copyFrom");
	var $spos = $s.length;
...
web2grid.core.work.FileStream.prototype.clear = function() {
	$s.push("web2grid.core.work.FileStream::clear");
	var $spos = $s.length;
	this.content = "";
	this.created = Date.now();
	this.changed = true;
...
web2grid.core.work.FileStream.prototype.isChanged = function() {
	$s.push("web2grid.core.work.FileStream::isChanged");
	var $spos = $s.length;
	{
		var $tmp = this.changed;
		$s.pop();
...
web2grid.core.work.FileStream.prototype.isAvailable = function() {
	$s.push("web2grid.core.work.FileStream::isAvailable");
	var $spos = $s.length;
	{
...
web2grid.core.work.FileStream.prototype.hxSerialize = function(s) {
	$s.push("web2grid.core.work.FileStream::hxSerialize");
	var $spos = $s.length;
...
web2grid.core.work.FileStream.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.core.work.FileStream::hxUnserialize");
	var $spos = $s.length;
...
web2grid.core.work.FileStream.prototype.__class__ = web2grid.core.work.FileStream;
web2grid.core.work.FileStream.__interfaces__ = [web2grid.core.iface.Persistent];
web2grid.worksource.boinc.request.FileUpload = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.FileUpload::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
...
web2grid.worksource.boinc.request.FileUpload.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.FileUpload::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
	indent = "";
	var innerindent = indent + "";
...
web2grid.worksource.boinc.BoincWorkUnit = function(unit) { if( unit === $_ ) return; {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::new");
	var $spos = $s.length;
	this.unitinfo = unit;
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.unitinfo = null;
web2grid.worksource.boinc.BoincWorkUnit.prototype.readytoreport = null;
web2grid.worksource.boinc.BoincWorkUnit.prototype.boincresult = null;
web2grid.worksource.boinc.BoincWorkUnit.prototype.uploader = null;
web2grid.worksource.boinc.BoincWorkUnit.prototype.boincboincresults = null;
web2grid.worksource.boinc.BoincWorkUnit.prototype.filesdownloaded = null;
web2grid.worksource.boinc.BoincWorkUnit.prototype.init = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::init");
	var $spos = $s.length;
	web2grid.core.work.BasicWorkUnit.prototype.init.call(this);
	this.boincresult = new web2grid.worksource.boinc.request.Result();
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.download = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::download");
	var $spos = $s.length;
	this.boincresult.state = 1;
	var downloader = new web2grid.core.net.Downloader();
	{
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.operate = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::operate");
	var $spos = $s.length;
	web2grid.core.work.BasicWorkUnit.prototype.operate.call(this);
	if(this.uploader != null) this.uploader.operate();
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkUnit.prototype.setUploadingState = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::setUploadingState");
	var $spos = $s.length;
	this.boincresult.state = 4;
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkUnit.prototype.setUploadedState = function(br) {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::setUploadedState");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.getResultState = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::getResultState");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.setResultState = function(s) {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::setResultState");
	var $spos = $s.length;
	this.boincresult.state = s;
	$s.pop();
}
web2grid.worksource.boinc.BoincWorkUnit.prototype.getBoincResult = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::getBoincResult");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.getUnitinfo = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::getUnitinfo");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.getWorkUnitResultName = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::getWorkUnitResultName");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.getScreenName = function() {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::getScreenName");
	var $spos = $s.length;
	{
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.hxSerialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::hxSerialize");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincWorkUnit.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincWorkUnit::hxUnserialize");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincUploaderPool = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.BoincUploaderPool::new");
	var $spos = $s.length;
	this.uploaders = new Array();
	this.onUpload = this.onupload = new henkolib.events.Event();
	$s.pop();
}}
web2grid.worksource.boinc.BoincUploaderPool.__name__ = ["web2grid","worksource","boinc","BoincUploaderPool"];
web2grid.worksource.boinc.BoincUploaderPool.prototype.uploaders = null;
web2grid.worksource.boinc.BoincUploaderPool.prototype.onupload = null;
web2grid.worksource.boinc.BoincUploaderPool.prototype.onUpload = null;
web2grid.worksource.boinc.BoincUploaderPool.prototype.init = function() {
	$s.push("web2grid.worksource.boinc.BoincUploaderPool::init");
	var $spos = $s.length;
	this.onUpload = this.onupload = new henkolib.events.Event();
	$s.pop();
}
web2grid.worksource.boinc.BoincUploaderPool.prototype.operate = function() {
	$s.push("web2grid.worksource.boinc.BoincUploaderPool::operate");
	var $spos = $s.length;
...
web2grid.worksource.boinc.BoincUploaderPool.prototype.isChanged = function() {
	$s.push("web2grid.worksource.boinc.BoincUploaderPool::isChanged");
	var $spos = $s.length;
	{
		var _g = 0, _g1 = this.uploaders;
		while(_g < _g1.length) {
...
web2grid.worksource.boinc.BoincUploaderPool.prototype.add = function(wu) {
	$s.push("web2grid.worksource.boinc.BoincUploaderPool::add");
	var $spos = $s.length;
	var ul = new web2grid.worksource.boinc.BoincUploader(wu);
	this.uploaders.push(ul);
	ul.uploadAll();
	$s.pop();
}
web2grid.worksource.boinc.BoincUploaderPool.prototype.hxSerialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincUploaderPool::hxSerialize");
	var $spos = $s.length;
	s.serialize(this.uploaders);
	$s.pop();
}
web2grid.worksource.boinc.BoincUploaderPool.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.worksource.boinc.BoincUploaderPool::hxUnserialize");
	var $spos = $s.length;
	this.uploaders = s.unserialize();
	this.init();
	$s.pop();
}
web2grid.worksource.boinc.BoincUploaderPool.prototype.__class__ = web2grid.worksource.boinc.BoincUploaderPool;
web2grid.worksource.boinc.BoincUploaderPool.__interfaces__ = [web2grid.core.iface.Operable];
web2grid.worksource.boinc.request.ResultFileinfo = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.worksource.boinc.request.ResultFileinfo::new");
	var $spos = $s.length;
	null;
	$s.pop();
}}
...
web2grid.worksource.boinc.request.ResultFileinfo.prototype.file_name = null;
...
web2grid.worksource.boinc.request.ResultFileinfo.prototype.toXmlString = function(indent) {
	$s.push("web2grid.worksource.boinc.request.ResultFileinfo::toXmlString");
	var $spos = $s.length;
	if(indent == null) indent = "";
	var innerindent = indent + "    ";
	var xml = indent + "<file_info>\n";
...
web2grid.core.work.WorkContext = function(p) { if( p === $_ ) return; {
	$s.push("web2grid.core.work.WorkContext::new");
	var $spos = $s.length;
	this.files = new Hash();
	this.created = Date.now();
...
web2grid.core.work.WorkContext.__name__ = ["web2grid","core","work","WorkContext"];
web2grid.core.work.WorkContext.prototype.program = null;
web2grid.core.work.WorkContext.prototype.files = null;
web2grid.core.work.WorkContext.prototype.checkpointdata = null;
web2grid.core.work.WorkContext.prototype.progress = null;
web2grid.core.work.WorkContext.prototype.console = null;
web2grid.core.work.WorkContext.prototype.created = null;
web2grid.core.work.WorkContext.prototype.worktime = null;
web2grid.core.work.WorkContext.prototype.exitstatus = null;
web2grid.core.work.WorkContext.prototype.completed = null;
web2grid.core.work.WorkContext.prototype.changed = null;
web2grid.core.work.WorkContext.prototype.init = function() {
	$s.push("web2grid.core.work.WorkContext::init");
	var $spos = $s.length;
	this.changed = false;
	this.console.setParent(henkolib.log.Console.main);
	$s.pop();
}
web2grid.core.work.WorkContext.prototype.isAvailable = function() {
	$s.push("web2grid.core.work.WorkContext::isAvailable");
	var $spos = $s.length;
...
web2grid.core.work.WorkContext.prototype.addFile = function(name,fs) {
	$s.push("web2grid.core.work.WorkContext::addFile");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.write = function(name,s) {
	$s.push("web2grid.core.work.WorkContext::write");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
	...
	if(this.files.exists(name)) {
		...
		var stream = new web2grid.core.work.FileStream();
		stream.write(s);
		this.files.set(name,stream);
	}
	$s.pop();
}
web2grid.core.work.WorkContext.prototype.read = function(name) {
	$s.push("web2grid.core.work.WorkContext::read");
	var $spos = $s.length;
	if(this.files.exists(name)) {
		{
...
web2grid.core.work.WorkContext.prototype.clear = function(name) {
	$s.push("web2grid.core.work.WorkContext::clear");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.setCheckpoint = function(data) {
	$s.push("web2grid.core.work.WorkContext::setCheckpoint");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.getCheckpoint = function() {
	$s.push("web2grid.core.work.WorkContext::getCheckpoint");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkContext.prototype.getCreatedDate = function() {
	$s.push("web2grid.core.work.WorkContext::getCreatedDate");
	var $spos = $s.length;
	{
		var $tmp = this.created;
		$s.pop();
...
web2grid.core.work.WorkContext.prototype.setProgress = function(progress) {
	$s.push("web2grid.core.work.WorkContext::setProgress");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.getProgress = function() {
	$s.push("web2grid.core.work.WorkContext::getProgress");
	var $spos = $s.length;
	{
		var $tmp = this.progress;
		$s.pop();
...
web2grid.core.work.WorkContext.prototype.setProgram = function(program) {
	$s.push("web2grid.core.work.WorkContext::setProgram");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.setProgramCode = function(program) {
	$s.push("web2grid.core.work.WorkContext::setProgramCode");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.getProgramCode = function() {
	$s.push("web2grid.core.work.WorkContext::getProgramCode");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkContext.prototype.getFileList = function() {
	$s.push("web2grid.core.work.WorkContext::getFileList");
	var $spos = $s.length;
	var list = new Array();
...
web2grid.core.work.WorkContext.prototype.log = function(level,message,data,source,pos) {
	$s.push("web2grid.core.work.WorkContext::log");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.addWorktime = function(time) {
	$s.push("web2grid.core.work.WorkContext::addWorktime");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.getWorktime = function() {
	$s.push("web2grid.core.work.WorkContext::getWorktime");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkContext.prototype.setExitStatus = function(status) {
	$s.push("web2grid.core.work.WorkContext::setExitStatus");
	var $spos = $s.length;
	if(this.completed) {
		$s.pop();
		return;
...
web2grid.core.work.WorkContext.prototype.getExitStatus = function() {
	$s.push("web2grid.core.work.WorkContext::getExitStatus");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkContext.prototype.isCompleted = function() {
	$s.push("web2grid.core.work.WorkContext::isCompleted");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkContext.prototype.setCompleted = function() {
	$s.push("web2grid.core.work.WorkContext::setCompleted");
	var $spos = $s.length;
	this.completed = true;
	this.changed = true;
	$s.pop();
}
web2grid.core.work.WorkContext.prototype.copyFrom = function(context) {
	$s.push("web2grid.core.work.WorkContext::copyFrom");
	var $spos = $s.length;
...
web2grid.core.work.WorkContext.prototype.isChanged = function() {
	$s.push("web2grid.core.work.WorkContext::isChanged");
	var $spos = $s.length;
	{ var $it0 = this.files.iterator();
...
web2grid.core.work.WorkContext.prototype.getLogNoticeText = function() {
	$s.push("web2grid.core.work.WorkContext::getLogNoticeText");
	var $spos = $s.length;
	{
...
web2grid.core.work.WorkContext.prototype.hxSerialize = function(s) {
	$s.push("web2grid.core.work.WorkContext::hxSerialize");
	var $spos = $s.length;
...
web2grid.core.work.WorkContext.prototype.hxUnserialize = function(s) {
	$s.push("web2grid.core.work.WorkContext::hxUnserialize");
	var $spos = $s.length;
...
web2grid.core.work.WorkContext.prototype.__class__ = web2grid.core.work.WorkContext;
web2grid.core.work.WorkContext.__interfaces__ = [web2grid.core.iface.Persistent];
...
{
	web2grid.core.net.Downloader.databank = new Hash();
}
{
	Math.__name__ = ["Math"];
	Math.NaN = Number["NaN"];
...
{
	web2grid.worksource.boinc.BoincWorkSource.version = new web2grid.worksource.boinc.request.ClientVersion(3,0,0);
	web2grid.worksource.boinc.BoincWorkSource.platform = "javascript";
}
{
...
{
	try {
		web2grid.js["Worker"] = Worker;
	}
	catch( $e6 ) {
		{
			var e = $e6;
			{
				web2grid.js["Worker"] = null;
			}
		}
	}
}
...
Main.savepath = "GridBeeClient_storage";
