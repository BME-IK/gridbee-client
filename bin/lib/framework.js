...
gridbee.worksource.boinc.webrpc.result.PendingCreditRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("total_claimed_credit: " + this.total_claimed_credit,{ fileName : "PendingCreditRes.hx", lineNumber : 23, className : "gridbee.worksource.boinc.webrpc.result.PendingCreditRes", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.result.LookupTeamsRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("Print first team:",{ fileName : "LookupTeamsRes.hx", lineNumber : 26, className : "gridbee.worksource.boinc.webrpc.result.LookupTeamsRes", methodName : "print"});
...
gridbee.worksource.boinc.webrpc.result.CreateTeamRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("teamid: " + this.teamid,{ fileName : "CreateTeamRes.hx", lineNumber : 14, className : "gridbee.worksource.boinc.webrpc.result.CreateTeamRes", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.lookupAccount = function(email,passwd) {
	...
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::lookupAccount@85");
		var $spos = $s.length;
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::lookupAccount@110");
		var $spos = $s.length;
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.getAccountInfo = function(Auth) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getAccountInfo@126");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getAccountInfo@151");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.setAccountInfo = function(Auth,email_addr,password,name,country,postal_code,global_prefs,project_prefs,yoururl,send_email,show_hosts,teamid,venue) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::setAccountInfo@205");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::setAccountInfo@230");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.createAccount = function(username,email,passwd) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::createAccount@250");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::createAccount@275");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.getCreditInformationWithID = function(Id) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getCreditInformationWithID@291");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getCreditInformationWithID@316");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.getCreditInformationWithAuth = function(Auth) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getCreditInformationWithAuth@332");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getCreditInformationWithAuth@358");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.getPendingCreditInfo = function(Auth) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getPendingCreditInfo@374");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getPendingCreditInfo@400");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.setHostInfo = function(Auth,hostid,venue) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::setHostInfo@416");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::setHostInfo@441");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.createTeam = function(Auth,TeamName,TeamType,TeamDescription,TeamCountry,TeamUrl,TeamNameHTML) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::createTeam@470");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::createTeam@495");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.lookupTeamByName = function(TeamName) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::lookupTeamByName@511");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::lookupTeamByName@536");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.lookupTeamByID = function(TeamID) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::lookupTeamByID@551");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::lookupTeamByID@576");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.getTeamMembersList = function(TeamID,TeamAdminAuth) {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getTeamMembersList@595");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getTeamMembersList@619");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.getServerStatus = function() {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getServerStatus@637");
		var $spos = $s.length;
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getServerStatus@669");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.getApplicationVersionsList = function() {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getApplicationVersionsList@685");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::getApplicationVersionsList@710");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.BoincWebRPC.prototype.projectConfiguration = function() {
	...
	var req = gridbee.core.net.HTTPRequest.get(url).send();
	req.onComplete.subscribe(function(response) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::projectConfiguration@726");
		var $spos = $s.length;
		var inXml = Xml.parse(response.content);
		var input = new haxe.xml.Fast(inXml.firstElement());
		if(input.getName() == "error") {
	...
	req.onError.subscribe(function(error) {
		$s.push("gridbee.worksource.boinc.webrpc.BoincWebRPC::projectConfiguration@751");
		var $spos = $s.length;
		operation.setError(error);
		$s.pop();
	});
...
gridbee.worksource.boinc.webrpc.subclasses.Applic.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("name: " + this.name,{ fileName : "Applic.hx", lineNumber : 25, className : "gridbee.worksource.boinc.webrpc.subclasses.Applic", methodName : "print"});
	haxe.Log.trace("id: " + this.id,{ fileName : "Applic.hx", lineNumber : 26, className : "gridbee.worksource.boinc.webrpc.subclasses.Applic", methodName : "print"});
	haxe.Log.trace("***Version descriptions***",{ fileName : "Applic.hx", lineNumber : 27, className : "gridbee.worksource.boinc.webrpc.subclasses.Applic", methodName : "print"});
	this.version.print();
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.subclasses.Daemon.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("host: " + this.host,{ fileName : "Daemon.hx", lineNumber : 22, className : "gridbee.worksource.boinc.webrpc.subclasses.Daemon", methodName : "print"});
	haxe.Log.trace("command: " + this.command,{ fileName : "Daemon.hx", lineNumber : 23, className : "gridbee.worksource.boinc.webrpc.subclasses.Daemon", methodName : "print"});
	haxe.Log.trace("status: " + this.status,{ fileName : "Daemon.hx", lineNumber : 24, className : "gridbee.worksource.boinc.webrpc.subclasses.Daemon", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.result.CreditInfoRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("id: " + this.id,{ fileName : "CreditInfoRes.hx", lineNumber : 57, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("cpid:" + this.cpid,{ fileName : "CreditInfoRes.hx", lineNumber : 58, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("create_time: " + this.create_time,{ fileName : "CreditInfoRes.hx", lineNumber : 59, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("name: " + this.name,{ fileName : "CreditInfoRes.hx", lineNumber : 60, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("country: " + this.country,{ fileName : "CreditInfoRes.hx", lineNumber : 61, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("total_credit: " + this.total_credit,{ fileName : "CreditInfoRes.hx", lineNumber : 62, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("expavg_credit: " + this.expavg_credit,{ fileName : "CreditInfoRes.hx", lineNumber : 63, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("expavg_time: " + this.expavg_time,{ fileName : "CreditInfoRes.hx", lineNumber : 64, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("teamid: " + this.teamid,{ fileName : "CreditInfoRes.hx", lineNumber : 65, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("url: " + this.url,{ fileName : "CreditInfoRes.hx", lineNumber : 66, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	haxe.Log.trace("has_profile: " + this.has_profile,{ fileName : "CreditInfoRes.hx", lineNumber : 67, className : "gridbee.worksource.boinc.webrpc.result.CreditInfoRes", methodName : "print"});
	$s.pop();
}
...
gridbee.core.work.BasicWorkUnit.prototype.start = function() {
	...
	if(this.state == gridbee.core.iface.WorkUnitState.Passive) {
		...
		this.ares.onComplete.subscribe(function(wc) {
			$s.push("gridbee.core.work.BasicWorkUnit::start@72");
			var $spos = $s.length;
		...
		this.ares.onError.subscribe(function(mes) {
			$s.push("gridbee.core.work.BasicWorkUnit::start@78");
			var $spos = $s.length;
			self.SwitchState(gridbee.core.iface.WorkUnitState.Completed);
		...
		this.ares.onProgress.subscribe(function(prog) {
			$s.push("gridbee.core.work.BasicWorkUnit::start@84");
			var $spos = $s.length;
...
gridbee.core.work.BasicWorkUnit.prototype.SwitchState = function(s) {
	...
	henkolib.log.Console.main.logDebug("Changed state to " + this.getStatusString(),null,null,{ fileName : "BasicWorkUnit.hx", lineNumber : 123, className : "gridbee.core.work.BasicWorkUnit", methodName : "SwitchState"});
...
gridbee.core.work.WorkUnitPool.prototype.terminateOne = function() {
	...
	var $spos = $s.length;
	henkolib.log.Console.main.logInformation("terminate one called on workunitpool",null,null,{ fileName : "WorkUnitPool.hx", lineNumber : 54, className : "gridbee.core.work.WorkUnitPool", methodName : "terminateOne"});
...
gridbee.core.info.BrowserInfo.detectBrowser = function() {
	...
	success = gridbee.core.info.BrowserInfo.checkBrowser("Opera Software","Opera",function(navigator) {
		$s.push("gridbee.core.info.BrowserInfo::detectBrowser@44");
		var $spos = $s.length;
		{
	...
	success = gridbee.core.info.BrowserInfo.checkBrowser("Microsoft","Internet Explorer",function(navigator) {
		$s.push("gridbee.core.info.BrowserInfo::detectBrowser@50");
		var $spos = $s.length;
		{
	...
	success = gridbee.core.info.BrowserInfo.checkBrowser("Google","Chrome",function(navigator) {
		$s.push("gridbee.core.info.BrowserInfo::detectBrowser@56");
		var $spos = $s.length;
		{
...
gridbee.worksource.boinc.webrpc.result.TeamMembrListRes.prototype.print = function() {
	...
	else haxe.Log.trace("No members",{ fileName : "TeamMembrListRes.hx", lineNumber : 22, className : "gridbee.worksource.boinc.webrpc.result.TeamMembrListRes", methodName : "print"});
	$s.pop();
}
...
gridbee.core.work.WorkSourcePool = function(p) { if( p === $_ ) return; {
	...
	this.init();
	henkolib.log.Console.main.logNotice("WorkSourcePool created: targetactive = " + this.targetactive,null,null,{ fileName : "WorkSourcePool.hx", lineNumber : 24, className : "gridbee.core.work.WorkSourcePool", methodName : "new"});
	$s.pop();
}}
...
gridbee.core.control.Client.prototype.restore = function() {
	...
	try {
		...
		if(string == null || string == "") {
			...
			henkolib.log.Console.main.logWarning("Client is not installed in this browser yet. Installing new settings.",null,null,{ fileName : "Client.hx", lineNumber : 123, className : "gridbee.core.control.Client", methodName : "restore"});
		}
		else {
			...
			henkolib.log.Console.main.logNotice("Loaded last settings from LocalStorage.",null,null,{ fileName : "Client.hx", lineNumber : 128, className : "gridbee.core.control.Client", methodName : "restore"});
		}
	}
	catch( $e0 ) {
		{
			var e = $e0;
			{
				...
				this.worksourcepool = new gridbee.core.work.WorkSourcePool();
				this.save();
				henkolib.log.Console.main.logError("Could not load from LocalStorage! Invalid data found! Installing new settings.",null,null,{ fileName : "Client.hx", lineNumber : 134, className : "gridbee.core.control.Client", methodName : "restore"});
			}
		}
	}
	$s.pop();
...
gridbee.worksource.boinc.webrpc.result.SetHostInfoRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("success: " + this.success,{ fileName : "SetHostInfoRes.hx", lineNumber : 18, className : "gridbee.worksource.boinc.webrpc.result.SetHostInfoRes", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.BoincWorkSource.prototype.init = function() {
	...
	if(this.host.host_info.p_fpops == 0) {
		...
		benchmark.onComplete.subscribe(function(c) {
			$s.push("gridbee.worksource.boinc.BoincWorkSource::init@103");
			var $spos = $s.length;
			self.host.host_info.p_fpops = benchmark.getFlops();
			self.updateHostInfo();
			self.benchmarkpool.removeCompleted();
			henkolib.log.Console.main.logInformation("Benchmark successfully executed.",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 108, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "init"});
			$s.pop();
		});
		benchmark.onError.subscribe(function(e) {
			$s.push("gridbee.worksource.boinc.BoincWorkSource::init@110");
			var $spos = $s.length;
			henkolib.log.Console.main.logError("Benchmark error: " + e,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 112, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "init"});
			self.benchmarkpool.removeCompleted();
			$s.pop();
		});
	...
	if(this.host.host_info.p_fpops != 0) {
		if(this.workpool.getNumInit() + this.workpool.getNumPassive() == 0 && !this.requestinprogress) {
			...
			newworks.onComplete.subscribe(function(wus) {
				$s.push("gridbee.worksource.boinc.BoincWorkSource::startOne@135");
				var $spos = $s.length;
				var _g = 0;
				while(_g < wus.length) {
					var wu = wus[_g];
					...
					henkolib.log.Console.main.logInformation("Workunit added to pool",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 141, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "startOne"});
				}
				$s.pop();
			});
			newworks.onError.subscribe(function(errormes) {
				$s.push("gridbee.worksource.boinc.BoincWorkSource::startOne@145");
				var $spos = $s.length;
				henkolib.log.Console.main.logNotice(errormes,null,null,{ fileName : "BoincWorkSource.hx", lineNumber : 147, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "startOne"});
				$s.pop();
			});
		}
...
gridbee.worksource.boinc.BoincWorkSource.prototype.requestWorks = function() {
	...
	request.setWorkRequest(new gridbee.worksource.boinc.request.WorkRequest(10));
	{
		...
		while(_g < _g1.length) {
			var work = _g1[_g];
			++_g;
			henkolib.log.Console.main.logInformation("Reporting uploaded results to: " + this.getScreenName(),null,work,{ fileName : "BoincWorkSource.hx", lineNumber : 212, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
	...
	http.errorCallback(function(error) {
		$s.push("gridbee.worksource.boinc.BoincWorkSource::requestWorks@221");
		var $spos = $s.length;
	...
	http.successCallback(function(response) {
		$s.push("gridbee.worksource.boinc.BoincWorkSource::requestWorks@222");
		var $spos = $s.length;
		henkolib.log.Console.main.logInformation("Received Boinc Scheduler reply.",null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 224, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		...
		if(reply.hostid != null) {
			...
			henkolib.log.Console.main.logNotice("Registered new host: " + reply.hostid,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 234, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			henkolib.log.Console.main.logNotice("Project name: " + reply.project_name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 235, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			henkolib.log.Console.main.logNotice("Username: " + reply.user_name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 236, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		}
		{
			...
			while(_g < _g1.length) {
				var ack = _g1[_g];
				++_g;
				henkolib.log.Console.main.logInformation("Received result ack: " + ack.name,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 244, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
				{
					...
					while(_g2 < _g3.length) {
						...
						if(work.getWorkUnitResultName() == ack.name) {
							...
							henkolib.log.Console.main.logNotice("Reported result accepted. WorkUnit removed.",null,work,{ fileName : "BoincWorkSource.hx", lineNumber : 250, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
		...
		}
		{
			...
			while(_g < _g1.length) {
				var message = _g1[_g];
				++_g;
				henkolib.log.Console.main.logNotice("BOINC " + message.priority + " priority message: " + message.message,null,self,{ fileName : "BoincWorkSource.hx", lineNumber : 261, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
			}
		}
	...
	henkolib.log.Console.main.logInformation("Sending Boinc Scheduler request.",null,this,{ fileName : "BoincWorkSource.hx", lineNumber : 334, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "requestWorks"});
	http.send();
	{
		$s.pop();
		return result;
...
gridbee.worksource.boinc.BoincWorkSource.prototype.reportWork = function(work) {
	...
	var $spos = $s.length;
	henkolib.log.Console.main.logInformation("Added to reporting queue: " + work.getScreenName(),null,this,{ fileName : "BoincWorkSource.hx", lineNumber : 342, className : "gridbee.worksource.boinc.BoincWorkSource", methodName : "reportWork"});
...
gridbee.worksource.boinc.webrpc.result.ServerStatusRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("update_time: " + this.update_time,{ fileName : "ServerStatusRes.hx", lineNumber : 50, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	haxe.Log.trace("software_version: " + this.software_version,{ fileName : "ServerStatusRes.hx", lineNumber : 51, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	if(this.daemon_arr != null) this.daemon_arr[0].print();
	haxe.Log.trace("results_ready_to_send: " + this.results_ready_to_send,{ fileName : "ServerStatusRes.hx", lineNumber : 54, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	haxe.Log.trace("results_in_progress: " + this.results_in_progress,{ fileName : "ServerStatusRes.hx", lineNumber : 55, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	haxe.Log.trace("workunits_waiting_for_validation: " + this.workunits_waiting_for_validation,{ fileName : "ServerStatusRes.hx", lineNumber : 56, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	haxe.Log.trace("workunits_waiting_for_assimilation: " + this.workunits_waiting_for_assimilation,{ fileName : "ServerStatusRes.hx", lineNumber : 57, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	haxe.Log.trace("workunits_waiting_for_deletion: " + this.workunits_waiting_for_deletion,{ fileName : "ServerStatusRes.hx", lineNumber : 58, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	haxe.Log.trace("results_waiting_for_deletion: " + this.results_waiting_for_deletion,{ fileName : "ServerStatusRes.hx", lineNumber : 59, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	haxe.Log.trace("transitioner_backlog_hours: " + this.transitioner_backlog_hours,{ fileName : "ServerStatusRes.hx", lineNumber : 60, className : "gridbee.worksource.boinc.webrpc.result.ServerStatusRes", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.BoincUploader.prototype.uploadAll = function() {
	...
	henkolib.log.Console.main.logNotice("Uploading results.",null,null,{ fileName : "BoincUploader.hx", lineNumber : 37, className : "gridbee.worksource.boinc.BoincUploader", methodName : "uploadAll"});
...
gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("p_fpops: " + this.p_fpops,{ fileName : "SystemRequirements.hx", lineNumber : 36, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	haxe.Log.trace("p_iops: " + this.p_iops,{ fileName : "SystemRequirements.hx", lineNumber : 37, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	haxe.Log.trace("p_membw: " + this.p_membw,{ fileName : "SystemRequirements.hx", lineNumber : 38, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	haxe.Log.trace("m_nbytes: " + this.m_nbytes,{ fileName : "SystemRequirements.hx", lineNumber : 39, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	haxe.Log.trace("m_swap: " + this.m_swap,{ fileName : "SystemRequirements.hx", lineNumber : 40, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	haxe.Log.trace("d_free: " + this.d_free,{ fileName : "SystemRequirements.hx", lineNumber : 41, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	haxe.Log.trace("bwup: " + this.bwup,{ fileName : "SystemRequirements.hx", lineNumber : 42, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	haxe.Log.trace("bwdown: " + this.bwdown,{ fileName : "SystemRequirements.hx", lineNumber : 43, className : "gridbee.worksource.boinc.webrpc.subclasses.SystemRequirements", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.result.ProjectConfigRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("name: " + this.name,{ fileName : "ProjectConfigRes.hx", lineNumber : 82, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("master_url: " + this.master_url,{ fileName : "ProjectConfigRes.hx", lineNumber : 83, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("local_revision: " + this.local_revision,{ fileName : "ProjectConfigRes.hx", lineNumber : 84, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("web_stopped: " + this.web_stopped,{ fileName : "ProjectConfigRes.hx", lineNumber : 85, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("account_creation_disabled: " + this.account_creation_disabled,{ fileName : "ProjectConfigRes.hx", lineNumber : 86, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("client_account_creation_disabled: " + this.client_account_creation_disabled,{ fileName : "ProjectConfigRes.hx", lineNumber : 87, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("min_passwd_length: " + this.min_passwd_length,{ fileName : "ProjectConfigRes.hx", lineNumber : 88, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("account_manager: " + this.account_manager,{ fileName : "ProjectConfigRes.hx", lineNumber : 89, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("uses_username: " + this.uses_username,{ fileName : "ProjectConfigRes.hx", lineNumber : 90, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("rpc_prefix: " + this.rpc_prefix,{ fileName : "ProjectConfigRes.hx", lineNumber : 91, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("error_num: " + this.error_num,{ fileName : "ProjectConfigRes.hx", lineNumber : 92, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
	haxe.Log.trace("sched_stopped: " + this.sched_stopped,{ fileName : "ProjectConfigRes.hx", lineNumber : 93, className : "gridbee.worksource.boinc.webrpc.result.ProjectConfigRes", methodName : "print"});
...
gridbee.worksource.boinc.webrpc.subclasses.Host.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("id: " + this.id,{ fileName : "Host.hx", lineNumber : 58, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("create_time: " + this.create_time,{ fileName : "Host.hx", lineNumber : 59, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("rpc_seqno: " + this.rpc_seqno,{ fileName : "Host.hx", lineNumber : 60, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("host_cpid: " + this.host_cpid,{ fileName : "Host.hx", lineNumber : 61, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("total_credit: " + this.total_credit,{ fileName : "Host.hx", lineNumber : 62, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("expavg_credit: " + this.expavg_credit,{ fileName : "Host.hx", lineNumber : 63, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("expavg_time: " + this.expavg_time,{ fileName : "Host.hx", lineNumber : 64, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("domain_name: " + this.domain_name,{ fileName : "Host.hx", lineNumber : 65, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("p_ncpus: " + this.p_ncpus,{ fileName : "Host.hx", lineNumber : 66, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("p_vendor: " + this.p_vendor,{ fileName : "Host.hx", lineNumber : 67, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("p_model: " + this.p_model,{ fileName : "Host.hx", lineNumber : 68, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("p_fpops: " + this.p_fpops,{ fileName : "Host.hx", lineNumber : 69, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("p_iops: " + this.p_iops,{ fileName : "Host.hx", lineNumber : 70, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("os_name: " + this.os_name,{ fileName : "Host.hx", lineNumber : 71, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	haxe.Log.trace("os_version: " + this.os_version,{ fileName : "Host.hx", lineNumber : 72, className : "gridbee.worksource.boinc.webrpc.subclasses.Host", methodName : "print"});
	$s.pop();
}
	...
	}
	{
		...
		while(_g < _g1.length) {
			...
			req.onComplete.subscribe(function(url) {
				$s.push("gridbee.core.net.Downloader::downloadAll@67");
				var $spos = $s.length;
				{
					var $tmp = function(response) {
						$s.push("gridbee.core.net.Downloader::downloadAll@67@67");
						var $spos = $s.length;
						var fs = new gridbee.core.work.FileStream();
			...
			req.onError.subscribe(function() {
				$s.push("gridbee.core.net.Downloader::downloadAll@80");
				var $spos = $s.length;
				{
					var $tmp = function(error) {
						$s.push("gridbee.core.net.Downloader::downloadAll@80@80");
						var $spos = $s.length;
...
gridbee.worksource.boinc.webrpc.subclasses.TeamMembr.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("id: " + this.id,{ fileName : "TeamMembr.hx", lineNumber : 55, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("email_addr: " + this.email_addr,{ fileName : "TeamMembr.hx", lineNumber : 56, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("email_ok: " + this.email_ok,{ fileName : "TeamMembr.hx", lineNumber : 57, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("cpid: " + this.cpid,{ fileName : "TeamMembr.hx", lineNumber : 58, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("create_time: " + this.create_time,{ fileName : "TeamMembr.hx", lineNumber : 59, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("name: " + this.name,{ fileName : "TeamMembr.hx", lineNumber : 60, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("country: " + this.country,{ fileName : "TeamMembr.hx", lineNumber : 61, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("total_credit: " + this.total_credit,{ fileName : "TeamMembr.hx", lineNumber : 62, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("expavg_credit: " + this.expavg_credit,{ fileName : "TeamMembr.hx", lineNumber : 63, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("expavg_time: " + this.expavg_time,{ fileName : "TeamMembr.hx", lineNumber : 64, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("url: " + this.url,{ fileName : "TeamMembr.hx", lineNumber : 65, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	haxe.Log.trace("has_profile: " + this.has_profile,{ fileName : "TeamMembr.hx", lineNumber : 66, className : "gridbee.worksource.boinc.webrpc.subclasses.TeamMembr", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.subclasses.Platforms.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("platform_name: " + this.platform_name,{ fileName : "Platforms.hx", lineNumber : 19, className : "gridbee.worksource.boinc.webrpc.subclasses.Platforms", methodName : "print"});
	haxe.Log.trace("user_friendly_name: " + this.user_friendly_name,{ fileName : "Platforms.hx", lineNumber : 20, className : "gridbee.worksource.boinc.webrpc.subclasses.Platforms", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.subclasses.PendingCredit.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("resultid: " + this.resultid,{ fileName : "PendingCredit.hx", lineNumber : 25, className : "gridbee.worksource.boinc.webrpc.subclasses.PendingCredit", methodName : "print"});
	haxe.Log.trace("workunitid: " + this.workunitid,{ fileName : "PendingCredit.hx", lineNumber : 26, className : "gridbee.worksource.boinc.webrpc.subclasses.PendingCredit", methodName : "print"});
	haxe.Log.trace("claimed_credit: " + this.claimed_credit,{ fileName : "PendingCredit.hx", lineNumber : 27, className : "gridbee.worksource.boinc.webrpc.subclasses.PendingCredit", methodName : "print"});
	haxe.Log.trace("received_time: " + this.received_time,{ fileName : "PendingCredit.hx", lineNumber : 28, className : "gridbee.worksource.boinc.webrpc.subclasses.PendingCredit", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.subclasses.ApplicVersion.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("platform_short: " + this.platform_short,{ fileName : "ApplicVersion.hx", lineNumber : 31, className : "gridbee.worksource.boinc.webrpc.subclasses.ApplicVersion", methodName : "print"});
	haxe.Log.trace("platform_long: " + this.platform_long,{ fileName : "ApplicVersion.hx", lineNumber : 32, className : "gridbee.worksource.boinc.webrpc.subclasses.ApplicVersion", methodName : "print"});
	haxe.Log.trace("version_num: " + this.version_num,{ fileName : "ApplicVersion.hx", lineNumber : 33, className : "gridbee.worksource.boinc.webrpc.subclasses.ApplicVersion", methodName : "print"});
	haxe.Log.trace("plan_class: " + this.plan_class,{ fileName : "ApplicVersion.hx", lineNumber : 34, className : "gridbee.worksource.boinc.webrpc.subclasses.ApplicVersion", methodName : "print"});
	haxe.Log.trace("date: " + this.date,{ fileName : "ApplicVersion.hx", lineNumber : 35, className : "gridbee.worksource.boinc.webrpc.subclasses.ApplicVersion", methodName : "print"});
	haxe.Log.trace("date_unix: " + this.date_unix,{ fileName : "ApplicVersion.hx", lineNumber : 36, className : "gridbee.worksource.boinc.webrpc.subclasses.ApplicVersion", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.BoincResult.prototype.SwitchState = function(newstate) {
	...
	this.changed = true;
	this.state = newstate;
	henkolib.log.Console.main.logDebug("Changed state to " + this.getState(),null,this,{ fileName : "BoincResult.hx", lineNumber : 76, className : "gridbee.worksource.boinc.BoincResult", methodName : "SwitchState"});
	$s.pop();
}
...
gridbee.worksource.boinc.BoincResult.prototype.operate = function() {
	...
	{
		{
			henkolib.log.Console.main.logInformation("Checking upload status.",null,this,{ fileName : "BoincResult.hx", lineNumber : 114, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
			...
			if(this.statusCheckOperation.isCompleted()) {
				...
				if(reply.status == 0) {
					if(reply.file_size == 0) {
						henkolib.log.Console.main.logInformation("This result is not uploaded yet.",null,this,{ fileName : "BoincResult.hx", lineNumber : 132, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
						this.SwitchState(gridbee.worksource.boinc.BoincResultState.ReadyToUpload);
					}
					else if(reply.file_size < this.data.length) {
						henkolib.log.Console.main.logInformation("Partial upload present. Continuing upload.",null,this,{ fileName : "BoincResult.hx", lineNumber : 139, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
						this.offset = reply.file_size;
						this.SwitchState(gridbee.worksource.boinc.BoincResultState.ReadyToUpload);
					}
					else {
						henkolib.log.Console.main.logInformation("This result has been already uploaded.",null,this,{ fileName : "BoincResult.hx", lineNumber : 147, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
						this.SwitchState(gridbee.worksource.boinc.BoincResultState.Uploaded);
					}
				}
				else {
					henkolib.log.Console.main.logWarning("Could not retrieve result status.",null,this,{ fileName : "BoincResult.hx", lineNumber : 153, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
	...
	{
		{
			henkolib.log.Console.main.logInformation("Uploading: " + (this.data.length - this.offset) + " bytes",null,this,{ fileName : "BoincResult.hx", lineNumber : 161, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
	...
	{
		{
			if(this.uploadOperation.isCompleted()) {
				...
				if(reply.message != null) {
					henkolib.log.Console.main.logWarning("Upload handler message: " + reply.message,null,this,{ fileName : "BoincResult.hx", lineNumber : 176, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
				}
				if(reply.status == 0) {
					henkolib.log.Console.main.logInformation("Uploaded successfully.",null,this,{ fileName : "BoincResult.hx", lineNumber : 181, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
					this.SwitchState(gridbee.worksource.boinc.BoincResultState.Uploaded);
				}
				else {
					henkolib.log.Console.main.logWarning("Could not upload result.",null,this,{ fileName : "BoincResult.hx", lineNumber : 186, className : "gridbee.worksource.boinc.BoincResult", methodName : "operate"});
					this.SwitchState(gridbee.worksource.boinc.BoincResultState.Error);
				}
			}
		}
...
gridbee.worksource.boinc.webrpc.subclasses.Team.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("id: " + this.id,{ fileName : "Team.hx", lineNumber : 43, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("create_time: " + this.create_time,{ fileName : "Team.hx", lineNumber : 44, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("userid: " + this.userid,{ fileName : "Team.hx", lineNumber : 45, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("name: " + this.name,{ fileName : "Team.hx", lineNumber : 46, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("url: " + this.url,{ fileName : "Team.hx", lineNumber : 47, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("type: " + this.type,{ fileName : "Team.hx", lineNumber : 48, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("country: " + this.country,{ fileName : "Team.hx", lineNumber : 49, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("total_credit: " + this.total_credit,{ fileName : "Team.hx", lineNumber : 50, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("expavg_credit: " + this.expavg_credit,{ fileName : "Team.hx", lineNumber : 51, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	haxe.Log.trace("expavg_time: " + this.expavg_time,{ fileName : "Team.hx", lineNumber : 52, className : "gridbee.worksource.boinc.webrpc.subclasses.Team", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.result.LookupAccRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("authenticator: " + this.Auth,{ fileName : "LookupAccRes.hx", lineNumber : 14, className : "gridbee.worksource.boinc.webrpc.result.LookupAccRes", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.webrpc.result.AccountCreateRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("authenticator: " + this.authenticator,{ fileName : "AccountCreateRes.hx", lineNumber : 16, className : "gridbee.worksource.boinc.webrpc.result.AccountCreateRes", methodName : "print"});
	$s.pop();
}
...
gridbee.worksource.boinc.BoincWorkUnit.prototype.download = function() {
	...
	dlresult.onComplete.subscribe(function(files) {
		$s.push("gridbee.worksource.boinc.BoincWorkUnit::download@76");
		var $spos = $s.length;
		{ var $it0 = files.keys();
...
gridbee.worksource.boinc.webrpc.result.SetAccountInfoRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("success: " + this.success,{ fileName : "SetAccountInfoRes.hx", lineNumber : 21, className : "gridbee.worksource.boinc.webrpc.result.SetAccountInfoRes", methodName : "print"});
	haxe.Log.trace("opaque_auth: " + this.opaque_auth,{ fileName : "SetAccountInfoRes.hx", lineNumber : 22, className : "gridbee.worksource.boinc.webrpc.result.SetAccountInfoRes", methodName : "print"});
	$s.pop();
}
...
Main.onload = function() {
	...
	Main.gbClient = new gridbee.core.control.Client("GridBeeClient_storage");
...
gridbee.core.work.WorkExecutor.prototype.onerror = function(event) {
	...
	var $spos = $s.length;
	this.temp.log(henkolib.log.LogLevel.L1_Error,"worker error: " + event.message,event,null,{ fileName : "WorkExecutor.hx", lineNumber : 82, className : "gridbee.core.work.WorkExecutor", methodName : "onerror"});
...
gridbee.core.work.WorkExecutor.prototype.onmessage = function(event) {
	...
	if(command == "exception") {
		this.temp.log(henkolib.log.LogLevel.L1_Error,data.type + " error",data.exception,null,{ fileName : "WorkExecutor.hx", lineNumber : 108, className : "gridbee.core.work.WorkExecutor", methodName : "onmessage"});
		this.context.copyFrom(this.temp);
		this.terminate();
	...
	if(command == "debug") {
		this.temp.log(henkolib.log.LogLevel.L5_Debug,"Debug",data,null,{ fileName : "WorkExecutor.hx", lineNumber : 139, className : "gridbee.core.work.WorkExecutor", methodName : "onmessage"});
	}
	$s.pop();
}
...
gridbee.core.work.FileStream.prototype.init = function() {
	...
	if(this.url != null && this.isavailable != true) {
		...
		var self = this;
		req.onComplete.subscribe(function(response) {
			$s.push("gridbee.core.work.FileStream::init@41");
			var $spos = $s.length;
		...
		req.onError.subscribe(function(r) {
			$s.push("gridbee.core.work.FileStream::init@47");
			var $spos = $s.length;
			self.iserror = true;
			$s.pop();
		});
...
gridbee.worksource.boinc.webrpc.result.AccountInfoRes.prototype.print = function() {
	...
	var $spos = $s.length;
	haxe.Log.trace("id: " + this.id,{ fileName : "AccountInfoRes.hx", lineNumber : 59, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("name: " + this.name,{ fileName : "AccountInfoRes.hx", lineNumber : 60, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("country: " + this.country,{ fileName : "AccountInfoRes.hx", lineNumber : 61, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("weak_auth: " + this.weak_auth,{ fileName : "AccountInfoRes.hx", lineNumber : 62, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("postal_code: " + this.postal_code,{ fileName : "AccountInfoRes.hx", lineNumber : 63, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("global_prefs: " + this.global_prefs,{ fileName : "AccountInfoRes.hx", lineNumber : 64, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("project_prefs: " + this.project_prefs,{ fileName : "AccountInfoRes.hx", lineNumber : 65, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("url: " + this.url,{ fileName : "AccountInfoRes.hx", lineNumber : 66, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("send_email: " + this.send_email,{ fileName : "AccountInfoRes.hx", lineNumber : 67, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("show_hosts: " + this.show_hosts,{ fileName : "AccountInfoRes.hx", lineNumber : 68, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("teamid: " + this.teamid,{ fileName : "AccountInfoRes.hx", lineNumber : 69, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("venue: " + this.venue,{ fileName : "AccountInfoRes.hx", lineNumber : 70, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	haxe.Log.trace("teamfounder: " + this.teamfounder,{ fileName : "AccountInfoRes.hx", lineNumber : 71, className : "gridbee.worksource.boinc.webrpc.result.AccountInfoRes", methodName : "print"});
	$s.pop();
}
...
}
{
	gridbee.js["XMLHttpRequest"] = typeof XMLHttpRequest != 'undefined'?XMLHttpRequest:typeof ActiveXObject != 'undefined'?function() {
		$s.push("gridbee.worksource.boinc.reply.DataServerReply::new@34");
		var $spos = $s.length;
		try {
			{
				var $tmp = new ActiveXObject("Msxml2.XMLHTTP");
